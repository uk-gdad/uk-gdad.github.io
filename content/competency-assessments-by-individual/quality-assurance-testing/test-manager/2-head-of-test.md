...
A test manager takes ownership of the quality assurance and testing (QAT) strategy as part of a broader risk-based approach. A head of test takes ownership of establishing policy for the test team and setting the testing strategy.
...
whether someone's judgement has become the organisation's reference point,
...
- 4 — Expert: Is someone the organisation turns to when a quality
  ...
  someone's judgement when making their own decisions about risk.

**Evidence to gather**

- Structured interview: ask about a time you built or grew the QAT
  community's standing outside your own organisation.
- Work sample: a piece of external-facing material — a conference talk
  outline, a cross-government working group paper — you produced or led.
- Referee question: ask a senior stakeholder whether you have sought your view when a quality dispute was contested.
...
- Work sample: a test standards document or technique evaluation you
...
- Structured interview: ask about a strategic decision to adopt or retire a
  ...
  supported it.
- Referee question: ask a peer test manager whether your
  standards or decisions shaped your own team's testing approach.
...
- Structured interview: ask about the most contested defect assessment
  you have been asked to arbitrate, and how you resolved it.
- Referee question: ask whether you have changed an
...
- 4 — Expert: Sets the organisation's standards and principles for test
  ...
  risk-based approaches, and is someone other teams cite when justifying
...
- Work sample: an organisational test policy or strategy document you own.
- Structured interview: ask how you use data to decide where to focus
  quality testing effort across the organisation.
- Referee question: ask a senior stakeholder whether organisational
  delivery processes changed because of your advocacy.
...
- Referee question: ask whether you have judged correctly when
