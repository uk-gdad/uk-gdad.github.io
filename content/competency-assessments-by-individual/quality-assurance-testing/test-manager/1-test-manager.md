...
A test manager takes ownership of the quality assurance and testing (QAT) strategy as part of a broader risk-based approach. A test manager takes ownership of delivery, creates the strategy and leads its implementation.
...
someone's influence and judgement are being sought and used beyond their
own immediate team.
...
- Structured interview: ask you to describe a time you had to
  tell a delivery lead that a release was not ready to ship, and how the
  conversation went.
- Work sample: a stakeholder-facing status report or risk summary you have
  written, reviewed for whether a non-technical reader could act on it.
- Observed scenario: give you a set of test results and defect
  trends for a fictional go/no-go decision, and try to explain what it
  means in plain language.
- Referee question: ask a referee to describe an occasion you
...
- 4 — Expert: Runs a structured process for improving test types and
  techniques over time, and is someone other teams ask for guidance on
  which technique fits a novel risk.

**Evidence to gather**

- Work sample: a test strategy or approach document you authored or led,
  showing the reasoning behind technique choices.
- Structured interview: ask you to describe a test environment or
  technique you introduced and what problem it solved.
- Document review: review meeting notes or standards documents you
  contributed to.
- Observed scenario: give a short feature description and ask which test
  types and techniques you would use, and why.
...
- Work sample: a defect trend report or root-cause analysis you produced.
- Structured interview: ask about a time defect data changed a decision
  beyond your own team.
- Referee question: ask a referee whether you have improved
  another team's defect management practice, and how.
- Document review: review a defect triage or severity policy you wrote or
  amended.
...
- 4 — Expert: Sets the organisation's approach to identifying which
  quality characteristics matter for a given delivery, and is someone
...
- Structured interview: ask you to describe a time you changed a test
...
- Observed scenario: give a short set of requirements and ask which quality
  characteristics you would test for and why, then ask what you would
  drop under time pressure.
- Referee question: ask about an occasion you coached someone
...
- 4 — Expert: Guides teams across the organisation in optimising their
  quality testing approaches using data, and is someone other test
...
- Work sample: a test strategy or quality plan covering more than one team
  or workstream.
- Structured interview: ask about a time you used data to change how more
  than one team approached quality testing.
- Document review: review evidence of advocacy for early quality
  involvement, such as a delivery process document you influenced.
- Referee question: ask a referee whether you have guided teams
  other than your own on quality testing strategy.
...
- Structured interview: ask you to explain why a particular test
  environment or tool matters for your current testing approach.
- Work sample: evidence of maintaining or supporting automated tests or
  tooling, such as a change to a test pipeline.
- Observed scenario: describe a flaky automated test and ask how you would
  approach it and who you would involve.
