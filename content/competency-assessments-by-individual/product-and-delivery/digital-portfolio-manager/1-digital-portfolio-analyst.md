...
A digital portfolio manager co-ordinates and manages a group , or ‘portfolio’, of digital projects. In this role, you will use an iterative and flexible approach to help define governance processes for this portfolio. A digital portfolio analyst supports the tracking, analysis and delivery of outcomes across a portfolio of digital projects. This role level may be called ‘associate digital portfolio manager’ in your organisation.
...
**Worked example — Communicating analysis and insight.** At 0, someone
cannot describe how they would present a finding to an audience. At 1 — the
baseline for this role level — someone can choose a reasonable medium to
...
contrast, someone presents complex analysis and visualisations clearly to
...
organisations. Because someone is still learning basic portfolio
...
- Think about how you'd explain why teams work in short iterations rather than
  planning everything up front.
- Ask for an example of a small piece of work you iterated on, and what
  changed between versions.
- Ask a supervisor whether you approaches new information with an
...
- Think about how you'd present a simple finding from a real or hypothetical
  dataset, and observe how you adapt it for a non-specialist listener.
- Ask for an example of a tactical recommendation you made based on your own
  analysis.
- Ask a supervisor how much support you typically needs to present
...
- Think about how you'd explain, using an example, why a project might need a
  governance checkpoint.
- Ask about a governance or assurance process you have followed, and what it
  was checking for.
- Ask a supervisor whether you follows governance processes
...
- Ask you why you think planning matters to a portfolio of
  projects, with a real or hypothetical example.
- Think about how you'd name two different ways a plan could be developed and when each
  might suit.
- Ask a supervisor whether you have supported planning activities,
...
- Think about how you'd describe a stakeholder relationship you managed
  directly, and how you tailored communication to that person.
- Ask about a time a stakeholder disagreed with something, and what you did.
- Ask a supervisor how much support you needs to manage a
...
- Think about how you'd explain how a piece of work you were involved in
  connected to a wider organisational goal.
- Ask about a strategic planning activity you supported, and what your role
  in it was.
- Ask a supervisor whether you shows curiosity about the strategic
  "why" behind your tasks, not just the tasks yourself.
