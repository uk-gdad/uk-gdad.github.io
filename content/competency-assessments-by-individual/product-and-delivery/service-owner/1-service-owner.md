...
**Worked example — Governance and assurance.** At 2, someone follows a
governance process someone else designed, preparing what is asked of them
for a service assessment. At 3, someone independently guides their own
team through a governance or assurance process and can explain why it is
proportionate. At 4 — the baseline for this role level — someone ensures
...
sustainably. The distinction you should look for is whether someone designed or reshaped the governance model itself, or only operated
...
- Ask for an example where you set or changed a delivery standard
  for your service, and why.
- Ask about an experiment in a new way of working you ran, and what you
  learned from it.
- Ask a referee whether you have researched an evolving delivery
  methodology and identified how it would change your own role.
...
guide people beyond someone's own team, which is the scale's own
...
- Ask for an example of a strategic decision you made or shaped
  using user insight, and the evidence behind it.
- Ask how you have coached someone else in making a user-centred decision.
- Ask a referee whether you have advocated for research approaches
...
- Ask for an example of a business case you secured sustainable
  funding for, and the benefits it promised.
- Ask about a time you were the escalation point for a financial or
  commercial risk, and how you resolved it.
- Ask a referee about a supplier relationship you owned and
  improved.
...
- Ask for an example where you designed or reshaped a governance
  or assurance process for your service.
- Ask how you prepared a team for a service assessment and what the outcome
  was.
- Ask a referee whether stakeholders trust your governance
...
well for someone's own service rather than teaching other services how
...
- Ask for an example of a measure you put in place to track user
  outcomes or business benefits.
- Ask how a metric changed a delivery decision you made.
- Ask a referee whether you have demonstrably built stakeholder
...
- Ask for an example of a continue, change-direction or stop decision you made, and the evidence behind it.
- Ask how you guided a stakeholder unfamiliar with a life cycle phase
  through it.
- Ask a referee whether your life cycle judgement calls have held
  up over time.
...
only someone's own delivery team.
...
- Ask for an example where you coordinated operations, policy,
  digital and delivery teams to resolve an operational issue together.
- Ask about a major operational issue you were the escalation point for.
- Ask a referee whether you have changed how a service scales or
  copes with demand.
...
approach other people in the team follow, not only managing someone's
own relationships.
...
- Ask for an example of a stakeholder relationship strategy you set
  for your team.
- Ask about a negotiation with a senior stakeholder that unblocked progress.
- Ask a referee whether you are trusted to represent the service to
...
well beyond someone's own service.
...
- Ask for an example of a long-term strategy you coached someone
  else to create or implement.
- Ask about a time you persuaded a sceptical senior stakeholder to support a
  strategic direction.
- Ask a referee whether you have kept a service's strategy aligned
