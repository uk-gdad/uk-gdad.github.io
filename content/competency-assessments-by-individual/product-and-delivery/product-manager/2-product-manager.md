...
A product manager makes sure that their products provide value and achieve the right outcomes by balancing user and business needs. A product manager is responsible for product quality and value, working with the team to identify, implement and improve strategies and tactics for their products. They might recruit and manage people in the product profession, ensuring people with the right skills are hired, supported and developed.
...
gap between 2 and 3 here is not about knowing the concepts — it is whether someone does this unsupervised and can defend the reasoning under challenge.
...
At the **product manager** level, someone is responsible for product
...
- Think about how you'd describe a real sprint or iteration you ran,
  including one thing that did not work and what you changed as a result.
- Look back at a retrospective output or action log you produced or contributed
  to.
...
- 4 — Expert: Builds a standing practice for how insight reaches
  decision-making across a product area, and is someone other product
  managers ask how to get insight from a hard-to-reach user group.

**Evidence to gather**

- Ask for an example of a decision you changed because of user research,
...
- Ask a referee whether you pushed for research to cover
...
- Think about how you'd walk through how you prioritised your current or
  most recent roadmap, including one item you chose not to build.
- Work sample: ask you to value-rank a short, anonymised list of roadmap
  items and explain the reasoning.
- Ask a referee about a time you escalated a risk to delivering
  value, and how you did it.
...
- 4 — Expert: Guides other product managers and stakeholders through life
  cycle decisions on complex or higher-risk products, and is someone
  consulted when a phase decision is contested.

**Evidence to gather**

- Ask about a product you moved from one phase to the next: what evidence
  supported the move, and who signed it off.
- Look back at a phase-gate or assessment document you contributed to.
...
- Think about how you'd describe the KPIs for your current product, how you
  were chosen, and one decision the data drove.
- Look back at a dashboard, report or stakeholder update you produced.
- Ask a referee whether your decisions were explained openly,
...
- Ask about a time you said no to a stakeholder request and how you
  handled it.
- Ask a referee whether you protected the team from unnecessary
  distraction, with an example.
- Ask about your involvement in any product management community, guild or
  community of practice.
...
- 4 — Expert: Recommends and adapts product management methods across
  multiple products or teams, and is someone others come to when scope
...
- Ask for an example of a stakeholder relationship that started difficult
  and how it improved.
- Look back at a stakeholder communications plan or update you authored.
- Ask a referee about an issue you resolved with a stakeholder
...
- Think about how you'd describe the strategy for your current product and
  your part in writing it.
- Look back at a strategy or vision document you contributed to.
