...
IT service transition managers provide overall planning for service transitions and co-ordinate the required resources. In this role, you will control the product life cycle of all changes, enabling beneficial changes to be made with minimum disruption to IT services. A service transition manager accepts products, determines whether they are fit for purpose and assesses readiness against agreed service acceptance criteria.
...
- Ask how you assures configuration accuracy before making a
...
- Ask for an example of weighing an availability or capacity KPI result when
  deciding whether to recommend go-live.
- Ask how you would handle a marginal capacity test result under time
  pressure.
...
- Ask a referee how you are regarded by other teams during a
  transition.
...
- Ask whether a product you accepted had continuity implications, and how
  you factored that into your recommendation.
...
- Give yourself a mock early-life-support incident and try to
  diagnose, prioritise, and propose a resolution.
- Ask for an example of an incident you investigated and resolved during
  early-life support.
...
- Ask for a specific example of an issue you followed through to
  resolution after handing it to another team.
- Ask a referee how reliably your issues got resolved.
...
- Ask about a preventative measure you determined and its effect.
...
- Think about how you'd describe the ITIL life cycle and where transition
...
- Ask for an example of using user needs evidence to influence a go-live
  recommendation.
- Ask how you balance technical acceptance criteria against user impact
