...
IT service transition managers provide overall planning for service transitions and co-ordinate the required resources. In this role, you will control the product life cycle of all changes, enabling beneficial changes to be made with minimum disruption to IT services. A service acceptance analyst co-ordinates across IT operations and manages the acceptance criteria for any changes within the area. At this level, you will validate changes against the acceptance criteria, gathering evidence and creating materials as necessary.
...
- Think about how you'd describe how you would log and correct an
...
- Think about how you'd explain, in your own words, what availability and
  capacity management processes cover.
- Ask whether you have flagged a capacity implication while validating a
  change.
...
- Ask a referee how closely you needed supervision.
...
- Think about how you'd describe how your work depends on other IT
  operations teams.
...
- Ask whether a change you validated had continuity implications, and how
  you handled it.
...
- Give yourself a mock incident description and try to register it
...
- Ask for an example of recognising a problem was outside your remit and
  routing it correctly.
- Ask how you decide who to pass a problem to.
...
- Think about how you'd explain the difference between a strategic, tactical
  and operational problem, with an example of each.
- Ask for an example of contributing to a remedy for a problem you helped
  investigate.
...
- Think about how you'd confirm your qualification and describe what it
  covered.
- Think about how you'd explain a basic framework concept in your own words.
...
- Ask how you would gather user needs evidence relevant to a change under
  review.
