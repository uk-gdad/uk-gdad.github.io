...
**Worked example — Incident management.** Someone who cannot describe what an incident record needs, or who has never logged one, sits at 0. Someone who can walk you through logging an incident they raised — what they captured, which queue they routed it to, and why — sits at 1 or 2, depending on how complete and accurate that walkthrough is. Someone who additionally explains how they judged which team should own it, and what they would do differently next time, is showing more than this level asks for and starts to look like evidence for the level above, not this one.
...
- Think about how you'd describe how you would pull together a basic report from a data repository, and what you would check before sharing it.
- Think about how you'd explain, in your own words, what a KPI is and why it matters to end user computing.
...
- Think about how you'd walk through an incident you logged: what you captured, how you decided which queue to route it to, and what you would check before submitting it.
...
- Ask a referee or current manager what proportion of your logged incidents needed correction or re-routing.
...
- Think about how you'd describe a time you noticed something was wrong (a device, an account, a piece of software) and what you did about it.
- Give a short scenario where it is unclear whether a user's problem belongs to the end user computing team or another team, and ask what you would do.
...
- Think about how you'd describe a problem you helped investigate, what evidence you gathered, and what the eventual fix or workaround was.
- Give a short scenario describing a recurring end user device fault and try to say what you would check first and why.
- Think about how you'd explain, in your own words, the difference between a strategic, a tactical and an operational problem.
...
- Think about how you'd explain, in plain terms, what a user story is and why it matters to someone supporting end user devices and services.
- Ask for an example — from work, study, or a personal project — where noticing a user's actual need changed how you handled something.
