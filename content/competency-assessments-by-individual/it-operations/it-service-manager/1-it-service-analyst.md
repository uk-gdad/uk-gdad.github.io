...
IT service managers are responsible for managing the service delivery of information and communications technology (ICT) services, and working with teams from IT service operations. An IT service analyst is responsible for frontline technical support to end users on issues relating to hardware, software and peripherals. This will include responding to, documenting and resolving service desk incident tickets in a timely manner according to a service level agreement (SLA).
...
- Think about how you'd walk through how you would log a new laptop and
  correct a record you found to be wrong.
- Look back at a sample of asset records you have previously updated, if
  available, for accuracy and completeness.
- Ask a referee whether your records needed frequent correction by
  others.
...
- Ask for an example of a recurring problem you noticed in a
  previous role, and what you did about it.
- Give a short scenario — repeated tickets about a printer driver, say — and
  ask how you would investigate it.
- Ask a referee for an example of you flagging a process
  improvement.
...
- Think about how you'd interpret a sample ticket volume or SLA report and
  summarise it for a non-technical stakeholder.
- Ask about a time you produced a report to a deadline and what it was used
  for.
- Ask a referee whether your reports were reliable and on time.
...
- Ask a referee how reliably your tickets got closed properly.
- Observe, if possible, how you manages a live queue over a shift.
...
- Think about how you'd describe the range of services or products you have
  supported and how you relate.
...
- Think about how you'd confirm your qualification and describe what it
  covered.
- Think about how you'd explain, in your own words, a basic framework concept such as
...
- Ask for an example of a difficult stakeholder conversation and how it was
  handled.
- Ask a referee about your communication style with end users under
  pressure.
- Give a scenario — an angry user chasing an overdue ticket — and ask how you
  would respond.
...
- Ask you how your previous role's day-to-day work connected to
  your team's or organisation's wider goals.
- Ask for an example, if any, of a suggestion you made that became policy.
...
- Ask for an example where you identified that a user's real
  problem was different from what you first asked for.
- Ask how you would spot a pattern across several similar tickets.
- Ask a referee whether your ticket handling reflected real
