...
IT service managers are responsible for managing the service delivery of information and communications technology (ICT) services, and working with teams from IT service operations. A senior IT service manager is responsible for service management across platforms, multiple channels and services to ensure service availability, performance and process maturity.
...
- Ask for an example of identifying and managing a configuration-related
  compliance risk.
- Ask how you would explain your configuration risk position to an
...
- Ask for an example of leading an investigation where different sources
  disagreed, and how you reached a recommendation.
- Ask a referee about your reputation for producing sound
...
- Ask for an example of a business decision you made or influenced
  using data analytics, and the outcome.
- Ask what tools or methods you use to turn service data into decisions.
...
- Ask for an example of improving how several platforms or channels worked
  together.
- Ask how you decides which underlying service relationships are
...
- Think about how you'd confirm your expert-level qualification and describe
  a complex situation where you applied it.
...
- Ask for an example of removing a serious blocker by influencing a resistant
  senior stakeholder.
- If you can, ask a manager, mentor or colleague to describe your standing with senior business
...
- Ask for an example of a strategy or policy you defined, and how
  you evaluated whether it worked.
- Ask how you have guided a more junior colleague through a strategic
  problem.
...
- Ask for an example of explaining, to a stakeholder resistant to it, why a
  user's stated request differed from your real need.
