...
**Worked example — Strategic thinking.** Someone who can describe strategic goals but cannot say how their work connects to them sits at 1 or 2. Someone who defines strategies and policies, and provides guidance to others on working within the strategic context, sits at 3 — this level's own baseline, matching the framework's own wording. Someone who additionally evaluates and reshapes existing strategies to exceed business requirements, and whose strategic work is adopted beyond their own area, is showing evidence closer to level 4.
...
- Think about how you'd describe an investigation you led into a business problem, including how you handled conflicting input from different stakeholders.
- Ask for the recommendation that resulted and whether it was acted on.
- Ask a referee how you performs when the evidence available is incomplete or contradictory.
...
- Ask you for an example of a relationship or delivery problem you spotted before anyone raised it.
- Ask a referee whether you tends to be reactive or proactive when a relationship starts to strain.
...
Baseline: 3 — Practitioner. At this level, the frameworks someone establishes need to work across the relationships they manage, not just for a single engagement, which fits Practitioner.
...
- Think about how you'd describe a framework or approach you established that other colleagues went on to use.
- Think about how you'd critique an existing engagement process and propose a coherent alternative.
...
- Think about how you'd explain how an ITIL life cycle stage applies to a relationship or engagement you manage.
...
- Think about how you'd describe a long-term strategic stakeholder relationship you built and sustained, and a moment it was tested.
- Ask a referee how senior stakeholders regard you.
...
- Think about how you'd describe a strategy or policy you defined, and how you guided others to work within it.
- Think about how you'd critique a current strategy and say where it falls short of business requirements.
...
Baseline: 3 — Practitioner. Championing user research and guiding others in prioritising the user story is independent leadership of this skill, which matches Practitioner; someone whose recommendations are already sought out organisation-wide should be rated 4.
...
- Think about how you'd describe a time you championed a user need against internal pressure to prioritise something else.
- Think about how you'd explain, with a real example, the difference between what a stakeholder asked for and what users actually needed.
- Ask a referee whether colleagues come to you for advice on user research tools or methods.
