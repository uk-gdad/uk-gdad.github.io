...
Command and control centre managers proactively monitor live services and performance trends to identify potential problems or areas for improvement that can then be investigated. A head of command and control is responsible for the strategy roadmap, integration and building the capability of the team.
...
- Think about how you'd describe how you identify and manage configuration-related risk across the whole operations estate.
- Ask a referee whether you have owned a compliance issue that reached senior management attention.
...
- Think about how you'd describe a time you identified a standard was not being correctly implemented, and the remedial action you initiated.
...
Baseline: 3 — Practitioner. The wording is unchanged from the level below, so the baseline stays at Practitioner rather than rising on wording alone; someone demonstrably setting or redefining release policy for the whole centre should be rated 4.
...
- Think about how you'd describe how you have built collaborative capability across a whole team over time, not just resolved one issue.
...
- Think about how you'd describe the continuity strategy you own, and the last major test you ran across it.
...
Baseline: 3 — Practitioner. The wording is unchanged from the level below, so the baseline stays consistent at Practitioner; someone demonstrably mentoring others through incident leadership should score 4.
...
- Think about how you'd describe the most complex incident you have led, and how you communicated with senior stakeholders throughout.
...
- Ask you for an example of a systemic issue you found and fixed before it became visible to users.
...
- Think about how you'd describe how you co-ordinate the team's response to a pattern of recurring problems.
...
- 4 — Expert: Is someone others rely on to see how the whole operations estate's underlying services should best work together, and sets the roadmap around it.

**Evidence to gather**

- Think about how you'd describe a time you improved outcomes by looking across a group of services rather than one in isolation, and how that informed the strategy roadmap.
...
- Think about how you'd describe how user needs for the services you support have changed over time, and how you made sure the strategy roadmap reflected that.
- Ask a referee whether other managers come to you for direction on which tools or methods to use.
