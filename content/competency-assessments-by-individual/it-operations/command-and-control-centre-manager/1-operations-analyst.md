...
Command and control centre managers proactively monitor live services and performance trends to identify potential problems or areas for improvement that can then be investigated. An operations analyst provides administrative support to their manager and alerts support staff if necessary.
...
**Worked example — Incident management.** Someone who cannot describe what an incident record needs sits at 0. Someone who can identify and register an incident, gathering the required information and allocating it to the appropriate channel, sits at 1 or 2 — this level's own baseline. Someone who additionally diagnoses and prioritises incidents and investigates their causes is showing evidence well beyond this level, closer to the level above.
...
- Think about how you'd describe how you would log and correct an asset record you found to be wrong.
- Give a short scenario with a discrepancy between a record and reality, and ask what you would do.
...
- Think about how you'd interpret a short, anonymised availability report and say what it shows.
- Ask what you would do if a monitored figure moved outside its expected range.
...
- Think about how you'd walk through a change you implemented and what procedure you followed.
...
- Think about how you'd walk through an incident you logged, what you captured, and how you routed it.
...
- Think about how you'd describe an issue you owned from alert to resolution or handover.
...
- Think about how you'd describe a monitoring pattern you helped investigate and what came of it.
...
- Think about how you'd describe how you would approach monitoring a new service you had not seen before.
...
- Ask you for an example of user or stakeholder feedback you collected and how it changed something you did.
