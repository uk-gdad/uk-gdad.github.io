...
An accessibility specialist provides support, advice and guidance to other roles in the Government Digital and Data profession about how to create accessible digital services. A junior accessibility specialist learns on the job by assisting with accessibility testing.
...
- Someone who knows accessibility legislation exists but cannot say where
  to find it, and cannot name a common accessibility issue in HTML without
  prompting, sits at **1 — Awareness**.
- Someone who runs the standard automated and manual checks unsupported —
...
- Someone who does all of that and also spots issues the automated tools
...
testing. At this level, the framework expects someone to:
...
- Give a short written brief describing a stakeholder request and try to identify, in your own words, what the stakeholder actually
  needs.
- Reflect on a recent time you in a stand-up, design crit or similar
  multidisciplinary discussion and note whether you contribute unprompted.
- Ask a referee, ideally a supervisor, how you behaves in team
  discussions.
...
The framework expects someone to show an understanding of the need for
...
- Give a written accessibility question that is not covered by an existing,
  documented pattern, and see whether you looks for established
  guidance, asks for help, or guesses.
- Think about how you'd describe a real occasion when you gave advice under
  supervision, and what precedent or guidance you used.
- Look back at any written recommendation or note you have produced, if
  available.
...
matrix, even though someone is at the most junior level of the role.
...
- Work sample: give a short webpage or document and try to
  identify and write up its accessibility issues.
- Reflect on a recent time you working through a checklist using a screen reader or
  other assistive technology.
- Structured interview question: ask you to explain a Web Content
  Accessibility Guidelines success criterion in your own words, and why it
  matters to a real user.
- Look back at a real audit, checklist result or finding you have
...
The framework expects someone to correctly execute test scripts under
...
- Reflect on a recent time you running a defined accessibility test script on a
  sample page or document.
- Ask what you do when a test result is unclear or borderline.
- Ask a referee how consistently you follows agreed test scripts.
...
- Think about how you'd take a real or example accessibility finding and
  explain which user it affects and how.
- Ask whether you have observed user research with disabled participants,
  and what you took from it.
- Structured interview question: ask about a user story you have read
