...
User researchers plan, design and carry out research activities with users that help teams get a deep understanding of the people that use government services. This research informs policy, proposition, service, content and interaction design so that services work well for users and achieve policy intent. A user researcher is usually embedded in a multidisciplinary team and responsible for planning and carrying out user research activities. At this level, you will be expected to work independently on a team.
...
- Think about how you'd describe a limitation of agile working you have encountered when
  planning research, and how you worked around it.
...
- Ask for a findings document or presentation you produced, if available.
- Ask how much support you needed for a recent analysis and synthesis exercise.
...
- Ask for an example of adapting a research session to include a participant with an
  access need.
- Ask a referee about your role in recruiting or including diverse
  participants.
...
- A structured interview question: "Tell me about a time you defined the scope and
  ...
  for help doing so."
- Ask for an example of changing your practice after reflection or feedback.
- Ask a referee how independently you defines research scope before it
  starts.
...
- Ask a referee how independently you manages your stakeholder
  relationships.
...
- Ask for a discussion guide, moderation script, or research plan you authored.
- Ask a referee how much support you needed to conduct a session correctly.
...
- A structured interview question: "Tell me about sharing a research insight with your
  team that changed how you thought about a user's behaviour or needs."
- Ask for an example of a user-centred practice you used, and why you chose it.
- Ask a referee whether you consistently advocates for the user in team
  discussions.
