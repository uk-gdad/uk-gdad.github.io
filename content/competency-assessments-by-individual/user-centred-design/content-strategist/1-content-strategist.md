...
A content strategist takes an overview of content and how it is produced. A content strategist is an expert practitioner in content strategy and taxonomy design.
...
- Someone who contributes ideas to a strategic discussion that get taken
  up, but has not led a strategy's design themselves, sits at **2 —
  Working**.
- Someone who leads the design and implementation of a content strategy
...
The framework expects someone to identify and compare the best processes
...
- Think about how you'd describe a time you helped a team choose between two
  delivery approaches for a content programme, and how you measured the
  outcome.
- Work sample: review a prioritisation or scoping decision document you
  produced or contributed to.
- Ask a referee how you handled scope creep or MVP discipline on a
  live piece of work.
...
The framework expects someone to understand when to use a specific
...
- Think about how you'd describe a case where you chose a specific
  prototyping technique for a taxonomy or content architecture problem, and
  why.
- Ask about a time you had to convince a stakeholder or team that
  prototyping was worth the time it took.
- Look back at any prototype, or a description of one, you produced for a
...
The framework expects someone to direct the stakeholder relationship
...
- Think about how you'd describe a time you negotiated directly with a
  senior stakeholder to resolve a disagreement that was blocking progress.
- Ask how you set stakeholder objectives for a team, and how you supported
  the team to meet you.
- Ask a referee, ideally a stakeholder or a peer, how you handles
...
The framework expects someone to lead the design and implementation of
...
- Think about how you'd walk through a strategy you led the design of, from
  intent to implementation.
- Work sample: review a strategy document or evaluation you led or
  directed.
- Ask a referee whether your strategic recommendations were
  adopted, and what difference you made.
...
The framework expects someone to give direction on which tools or methods
...
expert practice — but the wording frames someone as informing and
...
- 4 — Expert: Sets the user-focus approach across multiple teams and
  services, and is someone others in the organisation turn to for
  judgement on user need trends.

**Evidence to gather**

- Think about how you'd describe a case where you directed a team to use a
  particular tool or method to meet a specific user need, and why.
- Think about how you'd describe how user needs for your service have changed over
  time, and what the business changed as a result.
- Ask a referee for an example of you applying strategic thinking
...
- Think about how you'd walk through an end-to-end user journey you have
  worked on, and identify where you made a journey fix or content
  improvement.
- Ask about a time you coached or guided a more junior colleague on a piece
  of content, and what changed.
- Ask a referee, ideally someone you have directed or critiqued,
  how you gives feedback on content.
