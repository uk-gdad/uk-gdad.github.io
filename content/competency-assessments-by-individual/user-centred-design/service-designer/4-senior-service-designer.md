...
- Ask for a design decision document or risk log you authored, if available.
...
- Ask for an example of a design decision you made because of the personal or social
  context of users, not just the immediate task.
- Ask a referee whether you have been the person a team turned to for
...
- Ask for an example of a decision shaped by a technology, systems or policy
  constraint, and what trade-off you made.
- Look back at a design strategy document or pattern library entry you authored, if
  available.
...
- Ask for an example of working with a non-design profession, such as policy, to plan
  or run a session.
- Ask a referee whether other designers have asked you for advice on
  planning a session.
...
- Ask for an example of a design hypothesis you helped a team test, and what you
  learned.
- Look back at a piece of analysis or a research synthesis you produced, if available.
...
- Ask for an example of a prototype you built, and why you chose that fidelity.
...
- Ask a referee whether you have represented design to a digital or data
  leader outside your immediate team.
