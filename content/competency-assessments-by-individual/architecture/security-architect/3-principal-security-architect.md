...
A security architect designs and builds secure solutions. A principal security architect works on services of high complexity and risk, making decisions to enable the business to achieve its needs.
...
up in the accountabilities around them, not in new bullet points, and you should weigh that when scoring those two skills.
...
- A portfolio item: a policy, standard, or best-practice document you authored or substantially shaped.
- A reference question: "Has this person changed how your organisation
  approaches security analysis, beyond your own project?"
...
- 4 — Expert: Manages stakeholder expectations at the most senior levels
  under high risk, complexity, and constrained timescales, and is someone
...
- Direct observation, where possible: you presenting to a senior or
...
- A portfolio item: a precedent-setting design, standard, or architectural
  decision you led, with evidence of adoption beyond your own
  project.
...
- A reference question, put to a senior risk owner: "Do you treat this
  person as the final word on security risk in your area?"
- A document review: a risk assessment or escalation record for a genuinely
  complex, high-stakes decision you led.
...
- A portfolio item: publications, standards contributions, or cross-
  organisation briefings you produced.
...
- A reference question: "Do people outside this person's own organisation
  seek out your judgement on security technology?"
...
- A portfolio item: a policy or process document you authored or
  materially changed.
