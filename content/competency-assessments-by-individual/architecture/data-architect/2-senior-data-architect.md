...
A data architect sets the vision for the organisation’s use of data, through data design, to ensure that data is managed properly and meets the organisation’s needs. A senior data architect delivers the vision for the organisation as set by the chief data architect.
...
- Ask for an example of managing a senior stakeholder's expectations when a
  data architecture decision did not go the way you wanted.
...
- Ask how you prepare for a discussion you expect to be difficult.
...
- Ask for two examples of communicating the same finding to different
  audiences, and what changed between you.
- Look back at a document or presentation you produced and try to
  explain the choices you made for that audience.
...
- Walk through a data profiling exercise you led and what you did
  with the findings once colleagues had you.
...
- 4 — Expert: Shapes the organisation's whole approach to data governance and
  is someone other architects check their governance judgement against.

**Evidence to gather**

- Think about how you'd describe a governance requirement you helped define
  or change, and why it needed to change.
- Ask for an example of assuring a data service that served more than one
  business area, and what trade-off you had to manage.
...
- Think about how you'd pick a recent development in data tools or techniques
...
- Ask for two data models you produced in different subject areas,
  and how you aligned you where you overlapped.
- Present a scenario with two conflicting data models and ask how you would reconcile you.
...
- Ask for an example of a standard you created, and how you
  explained it to senior leaders.
- Ask for an example of a standards breach you were asked to make a
  recommendation on, and what you recommended.
...
- Think about how you'd describe a metadata repository you designed, and the
...
- Ask for an example of contributing to a strategy or policy document, and
  what your specific contribution changed.
- Ask how you have communicated a strategic goal to your team in a way that
