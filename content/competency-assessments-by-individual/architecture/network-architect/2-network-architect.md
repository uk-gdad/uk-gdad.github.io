...
A network architect is responsible for network designs and specifications, including cloud networks. A network architect has responsibility for network designs and specifications to support business strategies using common tools.
...
**Worked example.** Take Skill: Systems design. At 2 — Working, someone can produce a competent design for a well understood system when
...
- 4 — Expert: sets governance and assurance processes across a wider
  programme or organisation, and is someone others check a difficult
  governance judgement against.

**Evidence to gather**

- Think about how you'd describe a governance or assurance process you have
  designed or improved, and what problem it solved.
- Look back at a governance artefact you produced — a process document, a service
  assessment pack, an improvement proposal.
- Ask a referee for an example of you supporting a colleague through
...
- Think about how you'd describe an integration build you defined and
  coordinated, including how you sequenced the work across systems.
