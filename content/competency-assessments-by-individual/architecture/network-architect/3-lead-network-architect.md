...
A network architect is responsible for network designs and specifications, including cloud networks. A lead network architect is accountable for designs and networks representing their business area.
...
just technical accuracy — look for evidence someone has shaped governance
...
- Think about how you'd describe how you have shaped governance or assurance
  for a business area, not just a single project, and what changed as a
  result.
- Ask about a service assessment or equivalent governance forum you guided a
  team through, including how you handled a disagreement in it.
- Ask a referee — ideally a stakeholder outside the immediate team — whether
  you trust your team's governance without checking every
  decision, and why.
...
- Think about how you'd describe a piece of infrastructure work you led
  across a team or department, including how you divided the work and
  handled a setback.
- Ask a referee who reported to or worked under your lead on an
  infrastructure programme about how that leadership showed up day to day.
- Look back at a document showing your accountability for an
...
shapes practice beyond someone's own work.
...
- Think about how you'd describe a high-risk or high-complexity system you
  designed, including how you managed the risk and who else's work your
  decisions constrained.
- Ask for an example of you influencing a design standard, an industry model
  or a procurement strategy beyond a single project.
- Ask a referee for an example of you ensuring adherence to
...
- Think about how you'd describe an integration build you defined and
  coordinated across systems, particularly one involving teams outside your own.
- Review an integration plan or build schedule you produced or owned.
...
- Ask for an example of a problem escalated to you after other
  people had already tried and failed to diagnose it, and how you approached
  it differently.
- Walk through a real or simulated multi-capability fault scenario and
  observe how you decomposes it.
- Ask a referee for an example of you being the final point of
