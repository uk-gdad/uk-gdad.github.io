...
A software developer designs, runs and improves software that meets user needs. A junior developer learns on the job by delivering software components.
...
two junior developer people, both of whom have written code before.
...
- Someone who could design, code, test, and document a simple component
...
- Think about how you'd walk through, for a service you have worked on, what
  happens if it runs out of capacity or goes down — what you would expect to
  see, and who you would tell.
- During a pairing session or code review, note whether you mention
  availability or capacity impact unprompted when a change touches
  infrastructure or load-bearing code.
- Think about how you'd describe one occasion you read a monitoring dashboard or an
  incident channel, and what you took from it.
...
- Look back at a recent pull request of theirs for evidence of applied security
...
- Observe, or ask about, your use of the team's existing security tooling —
...
- Compare two or three of your recent pull requests against the team's
  documented standards — style guide, test conventions, commit conventions.
- Think about how you'd explain, in your own words, why the team follows one of its
  standards, for example why tests are written before code, or why a
  particular naming convention is used.
- During a pairing session, note whether you ask for guidance appropriately
...
- Review the tests, code and any documentation you produced for a recent
  small task.
- Think about how you'd explain a bug you found and fixed in your own code, and how
  you went about correcting it.
...
- Think about how you'd describe a time, in this role or in training, you built a
...
- Present a small hypothetical — "we're not sure if this approach will work"
  — and ask how you would find out cheaply.
...
that stay at explain-only for this level, provided someone can follow an
...
- Think about how you'd walk through the last service fault or maintenance task you
  helped with, and which procedure or runbook you used.
- Observe you shadowing, or taking part in, a support rotation or an
  on-call handover.
- Look back at a maintenance task or fault-fix you have logged, and check whether
...
- Think about how you'd describe a design discussion for a component you took part
  in, and what your contribution was.
- Look back at any design notes, diagrams or decision records you contributed to.
- Observe you in a design or architecture discussion, noting whether you
...
- Think about how you'd describe, for a system you have worked on, how it talks to
  another system and what could go wrong at that boundary.
- Look back at any tests you have written for an interface or an integration
  point.
...
- 3 — Practitioner: Notices when a technical decision might make the software
  harder to use, and raises it with the team or someone who wrote the
  story.
...
- Think about how you'd pick a recent story you worked on and explain, in your own
  words, the user need behind it.
- During a stand-up or a planning session, note whether you refer to user
  needs when discussing your work.
