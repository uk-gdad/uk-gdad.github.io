...
Commonly referred to as ‘DevOps engineers’, development operations engineers support the development and operation of software through tools, environments and practices. An apprentice DevOps engineer attends certified training and develops skills on the job.
...
- Think about how you'd explain, in plain terms, what happens when a service
  runs low on capacity and why a team would want to know in advance.
- Ask about a time you shadowed someone monitoring a live service, and what
  you noticed.
...
- Think about how you'd name a security control you have seen in use on a
  training exercise or in your current team, and explain what it protects
  against.
...
- Think about how you'd describe what could go wrong on a team that had no shared
...
- Give yourself a very small, well-scoped coding task typical of
  apprentice-level training, and observe how you approach it with support
  available.
- Think about how you'd describe, step by step, what happens between a developer
...
- Think about how you'd explain, in a sentence or two, why a team might build
  a rough version of something before building the real thing.
- Ask about a time you worked alongside someone else on a task (pair working
...
- Think about how you'd walk through a real or training-exercise fault you
  helped investigate, focusing on what task you were given and how you
  carried it out.
- Ask a referee or supervisor whether you reliably completes
