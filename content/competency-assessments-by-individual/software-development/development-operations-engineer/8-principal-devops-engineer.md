...
- Think about how you'd describe a time you identified a capacity issue
  spanning more than one team, and how you resolved it.
- Ask how you ensure availability and capacity standards are embedded
  across large or multiple teams, not just your own.
...
- Ask about a policy or standard you established that other teams now
  follow.
...
- Think about how you'd describe how security is embedded — not just
  reviewed at the end — across a large or multi-team delivery you led.
- Ask about a time you led another team through improving its information
  security practice.
...
- Ask you about a modern development standard or emerging practice
  you championed the adoption of, and the evidence you used to justify it.
- Ask how you led adoption of a standard across teams you did not directly
  manage.
...
- Ask you about a recent piece of hands-on technical work, to
  confirm you remain a credible technical authority.
- Ask how you balance hands-on credibility against a largely strategic
...
- Think about how you'd describe a time you coached someone else on choosing
  or running a prototyping method.
- Ask how you have approached prototyping a service end to end, rather than
  one part of it.
...
- Think about how you'd walk through a complex fault you diagnosed
  independently.
- Ask about a time you advised more than one team on the right service
  support approach.
...
- Ask to see a design you reviewed for a team you did not
  directly manage, and what you changed.
...
- Think about how you'd describe a standard or procedure you established
  across a product life cycle that spans more than one team.
- Ask how you resourced systems integration work to prevent it becoming a
...
- Ask how you guide others across teams on distinguishing user needs from
  stated user desires.
