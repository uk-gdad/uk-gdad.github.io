...
A data analyst collects, manages, explores and shares data to support organisational objectives and deliver business impact. A data analyst contributes to the planning, analysis and implementation of data. They work to appropriate standards and ensure data is used to achieve the team's goals.
...
cleanse data, ensuring it is fit for purpose". Someone who can only spot a
data quality issue when it is pointed out to them is showing **1 — Awareness**,
below this level's baseline. Someone who, given a moderately messy data
set, identifies quality issues themselves and resolves most of them correctly
is showing **2 — Working** — the baseline this level expects. Someone
...
- Think about how you'd describe a piece of analysis where you applied a
  statistical or analytical technique, and how you checked the result was
  right.
- Ask about a time a stakeholder questioned your analytical approach, and how
  you responded.
- Review an analytical report or output you have contributed to, if
  available.
...
- Think about how you'd describe a time you explained an analysis finding to
  a non-technical stakeholder, and how you knew it had landed.
- Ask about a discussion within a multidisciplinary team you took part in
  hosting, and what your role was.
...
- Think about how you'd describe a piece of work where you had to think about
  data ethics or privacy, and what you did.
- Ask who you would raise a privacy concern with in your current or a
  previous role, and whether you have done so.
...
- Think about how you'd describe a data governance policy you follow in your
  current or a previous role, and an example of applying it.
- Ask about a data management tool or procedure you use, and where you
...
- Give yourself a moderately messy data extract and try to identify
  and resolve the quality issues you find.
- Ask about a time you contributed to planning a data model, and what data
...
- Think about how you'd describe how you chose the visualisation for a piece
  of work, and what alternative you considered and rejected.
- Ask how you check a visualisation is accessible before sharing it.
...
- Think about how you'd describe a data product or piece of analysis you
  delivered, what business requirement it addressed, and how much support
  you needed.
- Think about how you'd explain how your day-to-day work connects to the
...
- Think about how you'd describe or, if appropriate, demonstrate a piece of
  code you designed for a specific research question.
- Ask why testing code matters, and how you have tested code you have
  written.
- Look back at a piece of analytical documentation you have produced, if
  available.
...
- Think about how you'd describe a data project you contributed to defining
  or planning, and what your specific contribution was.
- Ask about a time a project's requirements changed and how you adapted
