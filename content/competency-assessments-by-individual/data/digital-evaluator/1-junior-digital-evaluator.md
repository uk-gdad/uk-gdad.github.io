...
A digital evaluator assesses the design, implementation and outcomes of a digital product or service and whether it delivers value for the public and society. They may also be a member of a government analytical profession where evaluation is a core skill. A junior digital evaluator is an entry-level role. They have an understanding of the role and can show potential.
...
- Think about how you'd talk through a chart or short report you have seen or produced,
...
- If a portfolio exists, look for any written summary, however short, and try to
...
- A structured interview question: "What would you do if you thought some data you were
  ...
  is being used?"
- Think about how you'd describe the channels available in a previous team or a training
...
- A work sample: give you a small, realistic dataset and try to run a guided
  first-pass analysis, then talk through what you did.
...
- Ask a referee or training supervisor what level of direction you typically
...
- A structured interview question: "If a policy team asked you to help you work out
  whether your service was working, what would you ask you first, and why?"
- A short scenario: describe a fictional service and try to sketch what you would
  want to find out and how.
- Ask a training supervisor or referee whether you have observed or taken part
...
- Think about how you'd place a short list of evaluation activities (a survey, a live analytics
  review, an early user testing exercise) against the life cycle phase each best suits.
- Look back at any training material or coursework that covered the service standard's
  phases.
...
- A structured interview question: "What is a theory of change, and what would it
  usually include?"
- Think about how you'd explain the difference between watching how many people use a service
...
- If any training exercise produced a theory of change diagram or performance indicator
  list, ask you to talk through it.
...
- A work sample: give you a small, deliberately flawed dataset and try to
...
- Ask a referee or training supervisor whether you have flagged a data issue
  before, and how.
