...
A machine learning engineer develops, assures and maintains machine learning models so they can be used in products and services. A senior machine learning engineer develops machine learning models so they can be used in products and services.
...
- 4 — Expert: is someone the wider team asks which statistical technique to use for
...
- Ask a referee whether you have hosted a difficult discussion with a senior
  stakeholder.
...
- Ask how you keep current on data ethics developments relevant to machine learning,
  such as bias or fairness research, and for an example of applying something you
  learned.
...
- Ask for an example of identifying an opportunity to improve a data practice, and what
  changed as a result.
- Ask a referee about your practical range of data science tools and
  techniques.
...
- A work sample or take-home task: a specification of medium-to-high complexity for
  you to design, code, test and document.
...
- Look back at a real repository or codebase you can talk through, if available.
...
- Ask for an example of an integration testing activity you ran or supported.
- Ask a referee about your role in coordinating build activities across
