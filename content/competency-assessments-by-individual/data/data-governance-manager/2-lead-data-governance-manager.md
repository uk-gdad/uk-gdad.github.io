...
A data governance manager plans, monitors and enforces the management of data assets. A lead data governance manager undertakes complex work related to the principles and practices of data governance, and co-ordinates with data owners to lead wider data management competencies.
...
- Ask for an example of a finding you had to present that stakeholders did not want to
  hear, and how you framed it.
...
- Look back at a report, briefing or visualisation you authored, if available.
- Ask a referee whether you have coached colleagues on communicating analysis.
...
- Ask a referee whether you have hosted a difficult meeting on your behalf.
...
- 3 — Practitioner: independently identifies and addresses ethics and privacy concerns,
  ...
  policy.
- 4 — Expert: is someone other governance managers ask to review a proposed ethics
...
- Ask for an example of constructively challenging a proposed data ethics policy — what
  changed as a result.
- Ask a referee how you keeps current with developments in data ethics and
  privacy.
...
- Ask which part of a data governance framework you have held responsibility for, and
  how you monitored it through the data life cycle.
...
- Ask about any relevant data governance accreditation you hold or are working towards.
- Look back at a governance framework document or policy you authored or maintained, if
  available.
...
- Ask for an example where you judged the timing was wrong and recommended waiting.
- Ask a referee whether you have introduced a new data governance tool or
  technique to your team.
...
- A structured interview question: "Tell me about a continuous improvement you designed
  ...
  a result."
- Ask for an example of building data governance capability in someone outside your
  immediate team — an internal or external stakeholder.
- Ask which data governance industry standards you draw on, and how you keep current.
...
- Ask for an example of recommending data literacy to an audience above your own team
  — a director, a board, or another directorate.
- Ask a referee how you have helped build a more data-driven culture.
...
- Ask for an example of improving a data management practice in your team, and how
  you measured the improvement.
- Look back at a procedure or tool specification you helped define, if available.
...
- Ask how you measured whether data maturity actually improved as a result.
- Ask a referee about an area of data maturity you led on monitoring.
...
- 4 — Expert: is someone senior leaders ask to reconcile two conflicting standards
...
- Ask for an example of a standards breach you identified and your recommendation for
  resolving it.
- Ask a referee whether you have worked with subject matter experts across
...
- Ask for an example of judging that a risk sat outside tolerance, and what happened
  next.
- Ask a referee how you scales your approach between a low-impact and a
  high-impact risk.
...
- Ask for an example of a stakeholder communications strategy you helped develop and
  implement.
- Ask a referee whether you maintains stakeholder relationships even when
...
- Ask a referee whether other people have come to you for guidance on working
