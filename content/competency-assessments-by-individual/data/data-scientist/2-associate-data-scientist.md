...
This is a **proficiency** scale — it measures how well someone does the
...
someone can follow a written pattern to adapt an existing script, but
...
this role level, someone writes and tests a small script or a basic model
...
it. At 4 (Expert), someone sets the coding standard other people follow and
...
Someone applies analytical methods, including exploratory data analysis
...
Baseline: 2 — Working. The summary asks someone to apply and compare
...
- A work sample: give you a small, anonymised data set and try to run an exploratory analysis and report one finding with a supporting
  metric.
...
Someone identifies the appropriate engineering support needed to design and
...
- 4 — Expert: Designs the engineering approach for a new data product and is
  someone other associates ask when a cleansing process breaks.

**Evidence to gather**

- A work sample or task: ask you to spot and fix two or three
...
- Direct observation: watch, or ask a referee about, how the person responds
  when a data pipeline you rely on produces an unexpected result.
...
Someone applies fundamental principles of data ethics and privacy in their
...
supervision" — so the baseline for an associate is that someone applies the
...
- 4 — Expert: Shapes how the team handles data ethics and privacy risk, and is
  someone others in the team escalate a genuinely difficult judgement call
  to.
...
- A scenario to observe or discuss: present a short scenario involving a
  ...
  would do next and who you would tell.
- Something to ask a referee: whether the person has raised a data handling
  concern appropriately, and whether you needed prompting to do so.
...
Someone adopts an inquisitive and curious approach to data. They seek out
...
- 4 — Expert: Is someone the team turns to when they need to know what is
...
Someone shows an understanding of the organisation and the benefits data
...
- A work sample: ask you to present a piece of analysis twice, once
...
- A structured interview question: "Tell me about a piece of work you did that
  someone outside the data team actually used. How did you find out what you
  needed?"
...
Someone manages their own continuous professional development and can link
...
someone is expected to actually build things with the techniques they
...
Someone writes and tests scripts and creates basic models in one or more
...
- A work sample or task: ask you to write and test a small script or
...
Someone shows an awareness of the differences between delivery methods,
...
- A scenario to observe or discuss: a short scenario where a team priority
  ...
  your own work as a result.
- Something to ask a referee: whether the person reliably fits your
