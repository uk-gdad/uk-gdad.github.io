...
An analytics engineer transforms data relevant to the organisation into structures that enable analysis and decision-making. A head of analytics engineering oversees the development of a range of data models that meet analysis needs across the organisation.
...
- Ask a referee about your standing with senior stakeholders and
  whether you have represented a data function externally.
- Ask about a time you had to say no to a senior stakeholder and how you
...
- Ask you for an example, even if from earlier in your career, of
  bringing several disparate data sources together for analysis.
- Ask how you keep your own hands-on analytical skill current while working
...
- Think about how you'd describe a change in how the organisation works with
  data that you personally introduced, from spotting the trend to making it
  happen.
- Ask how you keep yourself informed of developments across the wider
  data field, not just your own specialism.
...
- Think about how you'd describe how you ensure modelling standards are
  followed across more than one team, and what you do when you are not.
- Ask about a relationship you have built with a senior data architect,
...
- Think about how you'd describe how you made the case for investment in
  metadata management to a senior stakeholder, and what happened.
- Ask about a governance process you set up to keep metadata accurate across
  more than one team.
...
- Think about how you'd describe a significant problem you anticipated and
  headed off before it caused harm, and how you saw it coming.
- Ask about a time you helped someone else learn to identify and describe a
...
- Think about how you'd describe a set of programming standards you set for a
  team or a project, and how you ensured compliance.
- Ask about a time you took technical responsibility for a whole project,
...
- Ask you how you satisfy yourself that testing practice across
  your whole team or community meets a good standard, given you are not
