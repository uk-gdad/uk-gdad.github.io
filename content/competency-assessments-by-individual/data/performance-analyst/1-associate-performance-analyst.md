...
A performance analyst conducts analysis. In this role, you will develop performance measurement frameworks - Key Performance Indicators (KPIs), goals, user needs and benefits - and analyse the performance of a service or product against these, adapting your approach and framework appropriately and in line with any changes. An associate performance analyst is an entry-level role requiring numeracy and some experience in analysis or data handling.
...
- Ask a referee how much support you needed applying an analysis technique.
...
- A work sample: give a small findings summary and try to choose how to present it
...
- Look back at a real chart or short written summary you produced, if one exists.
...
- Think about how you'd link a named performance measure (page views, processing time, error
  rate) to a plausible business objective.
- Look back at any training exercise that involved defining or explaining a performance
  measure.
...
- A work sample: a small, deliberately flawed dataset and try to describe what
  looks wrong.
- A structured interview question: "What would make you trust, or not trust, a set of
  numbers someone handed you?"
- Ask a referee whether you have flagged a data issue before, and how.
...
- A structured interview question: "What analytical tools have you used, even in
  training or study, and what did you use you for?"
- Think about how you'd describe, in plain terms, how digital technology affects the kind of
  service you'd be analysing.
- Look back at any coursework or training exercise involving an analytical tool.
...
- Think about how you'd place a short list of performance measures against the life cycle stage
  each best suits.
- Look back at any training material that covered the service standard's phases.
...
- Think about how you'd critique a piece of analysis (real or example) for whether it kept the
  user in view.
- Look back at any training exercise that asked you to connect data to a user need.
