...
An end user computing engineer is responsible for managing the product life cycle of all service-raised incidents (incident control) and all service requests (request control), requiring the use of knowledge management. In this role, you will also be responsible for informing customers on progress and advising on workarounds where necessary, as well as the support and maintenance of end user services. A principal end user computing engineer owns the strategy roadmap and leads on resourcing, learning and development for their team. At this level, you look at the bigger picture and understand trends in the business.
...
- Think about how you'd describe a decision you made using data analytics,
  and what business outcome it improved.
- Review an analysis or business case you produced from service data.
- Ask a referee about a data-driven decision you made that changed
...
- Ask a referee for an example of you spotting an opportunity across
