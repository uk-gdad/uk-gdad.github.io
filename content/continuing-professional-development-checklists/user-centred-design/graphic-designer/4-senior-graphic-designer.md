...
This last part of the checklist is written for your exact place in the UK GDAD PCF: the **Graphic designer** role at the **Senior graphic designer** level. You work with minimal support, influence and mentor others, work with service managers and programme directors to develop design concepts, may hold responsibility across complex services, help set direction and embed good practice, and make important decisions based on research. Your development now is about influence, direction, and depth.

Two companion files in this repository pair well with this checklist:

- Assessment: [`assessments/user-centred-design/graphic-designer/4-senior-graphic-designer.md`](../../../assessments/user-centred-design/graphic-designer/4-senior-graphic-designer.md)
- Upskilling: [`upskills/user-centred-design/graphic-designer/4-senior-graphic-designer.md`](../../../upskills/user-centred-design/graphic-designer/4-senior-graphic-designer.md)

### Role Level Focus: Senior Graphic Designer
...
- [ ] Deepen Design Systems Practice: Learn how large design systems are governed and evolved.
...
- [ ] Champion Sustainability: Make environmental impact a real factor in design decisions.
...
- [ ] Challenge Weak Evidence: Practise saying when the evidence does not support the conclusion.
...
### Skill Growth Plan: Toward Lead Graphic Designer

- [ ] Review the Next Level: Read the Lead graphic designer skill descriptions and mark your gaps.
