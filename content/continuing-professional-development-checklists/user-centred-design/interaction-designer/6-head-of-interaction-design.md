...
This last part of the checklist is written for your exact place in the UK GDAD PCF: the **Interaction designer** role at the **Head of interaction design** level. You are an expert practitioner with broad industry experience who defines and assures best practice while influencing, leading, and mentoring. You influence both design and organisational strategy and priorities, collaborate with counterparts across government, and focus on ensuring the right conditions and environment for designers to work effectively. Your development is now about leadership and stewardship.

Two companion files in this repository pair well with this checklist:

- Assessment: [`assessments/user-centred-design/interaction-designer/6-head-of-interaction-design.md`](../../../assessments/user-centred-design/interaction-designer/6-head-of-interaction-design.md)
- Upskilling: [`upskills/user-centred-design/interaction-designer/6-head-of-interaction-design.md`](../../../upskills/user-centred-design/interaction-designer/6-head-of-interaction-design.md)

### Role Level Focus: Head of Interaction Design
...
### Skill Growth Plan: Beyond Head of Interaction Design
