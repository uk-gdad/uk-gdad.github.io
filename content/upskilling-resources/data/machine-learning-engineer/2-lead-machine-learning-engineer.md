# Lead machine learning engineer - upskill resources

This page focuses on learning and growth resources for the work role of lead machine learning engineer.
...
- Set engineering standards for machine learning work through templates, review and shared platform components
- Own the whole lifecycle including retraining, monitoring and decommissioning, not just deployment
- Reduce the notebook-to-production gap deliberately, since that is where most effort is lost
- Make the cost and carbon of training and serving visible to the people funding the work
- Coach data scientists on production practice and learn from them on method
- Engage with data ethics and transparency requirements early, particularly the Algorithmic Transparency Recording Standard
- Keep enough research currency to know when a simpler approach would do the job
