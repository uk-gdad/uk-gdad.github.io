# Trainee data scientist - upskill resources

This page focuses on learning and growth resources for the work role of trainee data scientist.
...
At this role level you are inquisitive and keen to learn, with a basic understanding of software development and analytical methods, interpreting statistical output, preparing data, presenting effectively and becoming aware of ethical considerations. The resources below emphasise statistical foundations, programming basics and ethics awareness.
...
- [Data Science: Statistics and Machine Learning Specialization](https://www.coursera.org/specializations/data-science-statistics-machine-learning): A Johns Hopkins specialisation covering statistical inference, regression models, machine learning and the development of data products, typically completed in three to six months.
...
- Build the statistics foundations properly, because most costly analytical errors are statistical rather than technical
- Learn to explore and visualise a dataset before modelling it, and write down what you find
- Practise interpreting statistical output precisely, including what a confidence interval does and does not claim
- Ask about ethical considerations early, since raising them later is much harder
- Write a continuing professional development plan with your manager and revisit it every quarter
- Get your code reviewed, since reproducibility habits are much easier to build than to retrofit
- Present your work regularly, because explaining an analysis clearly is a skill that only improves with practice
