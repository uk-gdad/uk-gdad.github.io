# Data scientist - upskill resources

This page focuses on learning and growth resources for the work role of data scientist.
...
At this role level you work independently across the analytical life cycle, choosing appropriate methods, explaining findings to varied audiences, and using data ethically and appropriately. The resources below emphasise rigorous method, model evaluation and production practice.
...
- Take responsibility for the whole pipeline from question to decision, not just the modelling step
- Guard against data leakage deliberately, since it is the most common cause of overstated results
- Learn enough engineering to get a model into production and keep it working there
- Communicate uncertainty honestly, because overconfident findings damage trust permanently
- Mentor less experienced analysts by reviewing their reasoning as well as their code
- Keep a working knowledge of the policy or operational area you support, since context beats technique
- Build reusable tooling for problems your team solves repeatedly
