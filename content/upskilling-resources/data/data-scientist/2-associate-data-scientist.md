# Associate data scientist - upskill resources

This page focuses on learning and growth resources for the work role of associate data scientist.
...
- Move from running analyses to framing questions, since a well-framed question is most of the work
- Learn to prepare and manipulate data reproducibly, with version-controlled code rather than manual steps
- Understand the data engineering constraints around you, so your proposals are buildable
- Practise choosing the simplest method that answers the question, and justifying why it is sufficient
- Learn how your organisation handles data ethics and privacy, and use the channels that exist
- Build a habit of validating models on data that genuinely resembles production conditions
- Seek feedback from the people who will act on your findings, not only from other analysts
