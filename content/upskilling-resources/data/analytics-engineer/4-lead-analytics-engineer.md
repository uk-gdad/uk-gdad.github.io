# Lead analytics engineer - upskill resources

This page focuses on learning and growth resources for the work role of lead analytics engineer.
...
- Set standards for modelling, testing and documentation across the team, then review consistently against them
- Manage the modelled data estate as a portfolio, including the cost of keeping it correct
- Negotiate contracts and expectations with upstream producers and downstream consumers explicitly
- Develop your engineers by giving them ownership of whole domains rather than individual tickets
- Prioritise the metric definitions that the organisation argues about most, since consistency there pays best
- Work with governance colleagues so that the modelled layer is a trusted source rather than one of several
- Track and reduce warehouse cost deliberately, since transformation spend grows quietly
