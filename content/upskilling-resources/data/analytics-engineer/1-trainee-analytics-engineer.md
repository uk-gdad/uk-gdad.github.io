# Trainee analytics engineer - upskill resources

This page focuses on learning and growth resources for the work role of trainee analytics engineer.
...
At this role level you are learning the craft of transforming raw data into well-modelled, tested and documented data that analysts can trust, working with support and guidance. The resources below emphasise SQL, dbt fundamentals, modelling layers and testing.
...
- Learn SQL to a genuinely high standard, because it is the medium the whole role works in
- Adopt version control, testing and code review from your first project rather than later
- Learn the layering convention of staging, intermediate and mart models and follow it consistently
- Write tests that assert what the business expects, not only what the schema permits
- Talk to the analysts who consume your models and find out what confuses them
- Document models where consumers will actually read the documentation
- Read the pipeline quality research, since the common failure modes are already well catalogued
