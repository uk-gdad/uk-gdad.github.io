# Senior analytics engineer - upskill resources

This page focuses on learning and growth resources for the work role of senior analytics engineer.
...
At this role level you take responsibility for the quality and trustworthiness of the modelled data layer, set conventions, and guide less experienced colleagues. The resources below emphasise design standards, lineage, metric consistency and coaching.
...
- Set project conventions in writing and enforce them through continuous integration rather than reminders
- Take responsibility for the trustworthiness of the modelled layer, not just its existence
- Retire models that nobody uses, since an unused model still carries maintenance cost
- Coach analysts moving into analytics engineering, since that is the most common route into the role
- Work with data engineering colleagues on the boundary between raw ingestion and modelled data
- Make lineage and metric definitions visible to the whole organisation
- Keep enough hands-on practice to diagnose a hard modelling problem yourself
