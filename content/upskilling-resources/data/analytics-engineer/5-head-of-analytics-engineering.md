# Head of analytics engineering - upskill resources

This page focuses on learning and growth resources for the work role of head of analytics engineering.
...
At this role level you are accountable for the analytics engineering function, the strategy for the modelled data layer, and its credibility across the organisation. The resources below emphasise strategy, organisational influence and capability building.
...
- Set a strategy for the modelled data layer that names what it will and will not cover
- Judge the function by whether the organisation trusts and uses the models, not by how many exist
- Build the relationships with data engineering, analysis and governance that determine whether the layer holds
- Grow capability deliberately, since analytics engineering is a young discipline with a thin recruitment market
- Make consistent metric definition an organisational commitment, not a team preference
- Represent the discipline in governance forums so that expectations stay realistic
- Keep the cost and maintenance burden of the estate visible to the people who fund it
