# Head of data governance - upskill resources

This page focuses on learning and growth resources for the work role of head of data governance.
...
- [Data Governance: Strategies for Data Quality and Compliance](https://www.udemy.com/course/data-governance/): Covers the main frameworks including DAMA-DMBOK, the roles of data steward, owner and user, and privacy and compliance requirements including GDPR.

- [Data Governance in 2026: Frameworks, Compliance and Quality](https://www.udemy.com/course/data-governance-in-2025-frameworks-compliance-quality/): Explores DAMA-DMBOK, COBIT 2019, ISO/IEC 38500 and the NIST Cybersecurity Framework alongside the growing set of privacy regulations.

- [Certified Data Management Professional (CDMP)](https://www.udemy.com/course/certified-data-management-professional/): Preparation for the DAMA certification, which is the most widely recognised credential in the field.
...
- [DAMA-DMBOK Essentials: The Data Lifecycle](https://www.skillsoft.com/course/dama-dmbok-essentials-the-data-lifecycle-a3068d2f-9133-4e17-b88a-2b77048efd3e): Covers the stages of the data lifecycle and how organisations optimise handling from creation to disposal.
...
- [15.571 Generating Business Value from Information Technology](https://ocw.mit.edu/courses/sloan-school-of-management/15-571-generating-business-value-from-information-technology-spring-2009/syllabus/): Examines how organisations choose operating models balancing integration and standardisation, the decision that ultimately determines how much data governance is warranted.

## Blog posts

- [Data governance on the Government Data Architecture blog](https://dataarchitecture.blog.gov.uk/category/data-architecture/data-governance/): The UK government blog category on how data governance is applied in a departmental and cross-government setting.

- [Data Standards on the Data in Government blog](https://dataingovernment.blog.gov.uk/category/data-standards/): Posts on cross-government data standards work, including the practical difficulty of shared standards.
...
- [Data Stewardship Best Practices for Modern Enterprises](https://www.ovaledge.com/blog/data-stewardship-best-practices): Covers metadata, quality, glossary management, issue remediation and policy enforcement as the working content of the steward role.

- [Data Governance vs Data Stewardship: Explained In Detail](https://www.ovaledge.com/blog/data-governance-data-stewardship-explained): Distinguishes the two clearly, which matters when defining roles that people will actually be held to.

- [Data governance and operating model for analytics](https://cloud.google.com/blog/products/data-analytics/data-governance-and-operating-model-for-analytics-pt1): Covers designing a governance operating model specifically for analytical data.

- [Data Governance and Metadata Management: A Vital Duo for Data-Driven Success](https://atlan.com/data-governance-and-metadata-management/): Explains why governance without metadata infrastructure tends to stall.

- [Fundamentals of Metadata Management](https://www.dataversity.net/fundamentals-metadata-management/): Covers metadata types and repositories and how metadata underpins discoverability, lineage and governance.
...
- [Data Governance Policies, Standards and Stewardship](https://www.youtube.com/watch?v=uMdL_PQeYDk): Covers writing policies and standards that are specific enough to be followed.

- [Data Governance in the DAMA DMBOK](https://www.youtube.com/watch?v=J4jLYpRHNBw): Positions governance within the wider body of knowledge and its other knowledge areas.

- [The Ultimate Beginner's Guide to Data Governance: DAMA, DCAM, Metadata and More](https://www.youtube.com/watch?v=1yaNI5rwDVU): A broad orientation across the main frameworks and their differences.

- [Is Everything on the DAMA Wheel Data Governance?](https://www.youtube.com/watch?v=8O_Od7K4D5Q): A useful corrective on scope, since governance functions frequently expand until they can deliver nothing well.

- [Data Governance, Data Stewardship, Planning and Data Quality](https://www.youtube.com/watch?v=lA9i190y_0I): A practitioner conversation covering how the pieces fit together in a working organisation.

- [Data Management and the DMBOK2: goals, principles and data as an asset](https://www.youtube.com/watch?v=BChMt7E4BIU): Covers the framing of data as an organisational asset and what follows from taking that seriously.

- [Data Catalog vs Metadata Management](https://www.youtube.com/watch?v=vkKGLJd9m3U): Useful background on the tooling landscape governance functions are usually asked to procure.

- [Business Capability Mapping in Enterprise Architecture: Align Tech with Business](https://www.youtube.com/watch?v=ekCa3Gj0kDg): A framing device for connecting governance work to organisational capability and outcome.
...
- Set a governance strategy that names the outcomes it exists to deliver and what it will not cover
- Judge the function by whether data is trusted, findable and lawfully used, not by policy count
- Build senior sponsorship deliberately, since governance without authority is advisory at best
- Grow stewardship capability across the organisation rather than concentrating it in your team
- Align with cross-government data standards, since interoperability is where the value compounds
- Work with the chief data officer, privacy and security colleagues as partners rather than as gatekeepers
- Retire governance activity that no longer changes behaviour, so the function stays credible
