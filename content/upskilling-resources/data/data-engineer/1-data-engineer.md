# Data engineer - upskill resources

This page focuses on learning and growth resources for the work role of data engineer.
...
At this role level you build and maintain data pipelines and the systems that move and transform data for the organisation. The resources below emphasise pipeline construction, SQL and programming foundations, and data quality practice.
...
- Learn SQL and one programming language properly before adding more tools to your stack
- Write tests for your pipelines, because silent data errors are worse than loud failures
- Understand the data you are moving well enough to notice when it looks wrong
- Learn how your orchestrator actually retries and recovers, since that is where most incidents are resolved
- Keep everything in version control, including configuration and schema definitions
- Read the pipeline quality research, because the common failure modes are well documented
- Pair with analysts and data scientists so you understand how your outputs are used
