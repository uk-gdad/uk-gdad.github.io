# Lead data engineer - upskill resources

This page focuses on learning and growth resources for the work role of lead data engineer.
...
At this role level you lead a data engineering team, set technical standards, and take responsibility for the reliability of the data platform your consumers depend on. The resources below emphasise platform leadership, standards, and coaching.
...
- Set engineering standards for your team through templates, review and shared libraries
- Manage the reliability of the whole data platform, not just individual pipelines
- Negotiate data contracts with upstream producers rather than absorbing their changes silently
- Coach engineers by reviewing design decisions rather than rewriting their code
- Balance new capability against the maintenance burden your team is already carrying
- Work with architecture and governance colleagues so that platform decisions stick
- Keep enough hands-on depth to diagnose a hard problem yourself when it matters
