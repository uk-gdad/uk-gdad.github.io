# Head of data engineering - upskill resources

This page focuses on learning and growth resources for the work role of head of data engineering.
...
At this role level you are accountable for the data engineering function, its platform strategy, its capability and its relationships with data producers and consumers across the organisation. The resources below emphasise strategy, organisational influence and capability building.
...
- Set a platform strategy that names what the team will and will not support
- Judge the function by data availability and reliability for consumers, not by pipelines built
- Invest in the boring reliability work, since that is what determines whether anything else is trusted
- Grow and retain engineers through a visible development path and real technical ownership
- Build partnerships with upstream service owners, because most data problems begin at source
- Represent data engineering in governance forums so that commitments are realistic
- Track and reduce the cost of the platform deliberately, rather than letting it grow unexamined
