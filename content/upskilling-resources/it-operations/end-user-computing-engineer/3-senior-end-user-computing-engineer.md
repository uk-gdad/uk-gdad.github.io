# Senior end user computing engineer - upskill resources

This page focuses on learning and growth resources for the work role of senior end user computing engineer.
...
At this role level you manage the team while still solving technical problems. You co-ordinate and prioritise work to resolve incidents quickly, work closely with infrastructure, capacity and availability colleagues, and escalate repeat issues rather than absorbing them. The resources below emphasise prioritisation, reporting that stakeholders can act on, change impact assessment, and the team leadership that comes with the level.
...
- [Site Reliability Engineering (SRE) Principles](https://www.coursera.org/learn/site-reliability-engineering-principles): Reliability measurement and incident response, which is the language of the infrastructure and availability colleagues you work with.

## Udemy courses

- [Successful ITSM Incident and Major Incident Management ITIL](https://www.udemy.com/course/successful-itil-incident-and-major-incident-management/): Incident management from logging to resolution, including P1 and P2 handling, communication and post-incident analysis.
...
- [Release, Service Level, and Availability Management: ITIL](https://www.skillsoft.com/course/release-service-level-and-availability-management-1315d748-aa95-4681-b2a4-cfb2eb223096): Service level and availability management, which is where your work meets the capacity and availability managers.

- [Managing and Engaging Stakeholders](https://www.skillsoft.com/course/managing-and-engaging-stakeholders-cc794623-8e14-4d01-9835-34f500b252ce): Stakeholder processes and influence, relevant to agreeing reporting changes with the people who read them.
...
- [Introduction to DevOps and Site Reliability Engineering (LinuxFoundationX)](https://www.edx.org/learn/devops/the-linux-foundation-introduction-to-devops-and-site-reliability-engineering): The organisational and technical shift these practices involve.
...
- [Digital Employee Experience and Unified Endpoint Management Best Practice Guide, baramundi](https://www.baramundi.com/en-us/dex-uem-best-practice-guide/): Connecting endpoint practice to measured user experience, which is the reporting narrative you need.
...
- [Monitoring Distributed Systems, Google SRE Book chapter 6](https://sre.google/sre-book/monitoring-distributed-systems/): The four golden signals, and shared vocabulary with the availability managers you work with.

- [Guidance and tools for digital accessibility, GOV.UK](https://www.gov.uk/guidance/guidance-and-tools-for-digital-accessibility): Accessibility expectations your team's builds and configurations have to meet.

- [Operate a reliable service, GOV.UK Service Standard point 14](https://www.gov.uk/service-manual/service-standard/point-14-operate-a-reliable-service): The reliability standard your service contributes to.
...
- [Examining the relationship between System Quality, Knowledge Quality and User Satisfaction in the Success of Knowledge Management System](https://www.researchgate.net/publication/327024236_Examining_the_relationship_between_System_Quality_Knowledge_Quality_and_User_Satisfaction_in_the_Success_of_Knowledge_Management_System_An_Empirical_Study): Knowledge quality as a driver, relevant because knowledge management is core to this role.

- [Capacity and availability management by quantitative project management in the IT service industry](https://www.emerald.com/ajq/article-abstract/13/2/163/60850/Capacity-and-availability-management-by): A quantitative approach, useful when working with capacity and availability managers.
...
- [How to Automate Incident Postmortems for Consistent SRE and DevOps Reporting](https://www.youtube.com/watch?v=E53e-3RTU80): Structured reporting from real signals, applicable to your own reporting cycle.

- [Postmortem Culture at Google](https://www.youtube.com/watch?v=qgHWzQ2zcqQ): Blameless review as a team standard rather than an occasional exercise.

- [Full-stack Observability](https://www.youtube.com/watch?v=toS5rvET7hg): The signal landscape you share with infrastructure and availability colleagues.
...
- [PagerDuty Guide: On-Call and Incident Management Best Practices](https://www.youtube.com/watch?v=McBrUhz9Ia4): Practices worth codifying for the team you manage.

- [Insights on How Team Topologies Drive Organizational Success, Manuel Pais at GOTO 2024](https://www.youtube.com/watch?v=HKS5sKsIkkc): Organisational design for flow, which is often the answer to a persistent prioritisation problem.
...
- [Root Cause Analysis: The Core of Problem Solving and Corrective Action](https://www.amazon.com/Root-Cause-Analysis-Problem-Corrective-ebook/dp/B0BQJQQZ8C): By Duke Okes. A disciplined method for the repeat issues you escalate.
...
- Prioritise by user impact and by whether the fix prevents recurrence, not only by ticket age
