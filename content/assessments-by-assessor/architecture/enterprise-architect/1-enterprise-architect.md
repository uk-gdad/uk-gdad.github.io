...
This document is written for you: an assessor administering a psychometric assessment to a candidate for the enterprise architect role in the UK Government Digital and Data profession. It gives you everything you need to run the four most common types of workplace psychometric assessment for this role level — a full set of practice items, worked answers, and explanations that serve as your answer key.

Psychometric assessments are structured, standardised exercises that measure the mental processes and judgement a role genuinely requires. For an enterprise architect, that means far more than abstract puzzles. Well-designed, job-specific assessments mirror the real work of the role: translating business strategy into technical delivery, weighing architectural options against value for money, reading dense policy and standards documents, interpreting portfolio budgets and capacity figures, and navigating complex stakeholder relationships across an entire organisation. Because the role sits at the intersection of business, technology and data, assessments for enterprise architects tend to be broad, strategic, and scenario-rich — and that is exactly how this document approaches them.

This resource is organised into four main sections, one for each assessment type:

1. **Workplace job-specific cognitive assessment** — measuring pattern recognition, logical deduction, error checking, prioritisation and problem solving using the artefacts an enterprise architect genuinely handles: roadmaps, reference architectures, principles, standards, and transition states.
2. **Workplace job-specific numeric reasoning assessment** — measuring the candidate's ability to interpret budgets, licensing costs, capacity figures, portfolio metrics, and total cost of ownership comparisons.
3. **Workplace job-specific verbal reasoning assessment** — measuring precise comprehension of the written material the role requires day to day: architecture principles, government standards, strategy papers, governance minutes, and stakeholder emails.
4. **Workplace job-specific situational judgement assessment** — measuring the quality of professional judgement in realistic dilemmas involving senior stakeholders, delivery teams, governance boards, and suppliers.

Each section explains what the assessment measures, maps it explicitly to the skills in the role profile — architecting for the whole context, architecture communication, commercial perspective, community collaboration, enterprise architecture, making architectural decisions, problem definition and shaping, and strategy design — and then gives a substantial set of practice items with full worked answers and explanations, followed by notes on what distinguishes a strong candidate's response and common pitfalls to watch for.

How should you use this document? Administer the same items and the same time limit to every candidate you assess for this role level, so that results are comparable across candidates. Hold back the worked answers and explanations from the candidate until after they have completed the assessment — they are your answer key, not preparation material. Once scoring is complete, debrief the candidate: walk through where their responses were strong and where they diverged from what a strong answer demonstrates, so the assessment also serves their development. Remember throughout that this is one input among several in a hiring or promotion decision, never the sole basis for it — combine it with structured interview evidence, work samples and reference checks, and administer it consistently across every candidate for this role level.
...
A workplace job-specific cognitive ability assessment is a targeted psychometric test that measures the exact mental processes an enterprise architect role requires — not abstract intelligence, but applied thinking. Unlike a generic IQ test, it uses practical workplace scenarios and realistic artefacts to predict how effectively a candidate will perform in the role. Present the candidate with items that mimic the everyday tasks and data formats of the actual job: architecture roadmaps, dependency maps, principles catalogues, transition-state plans, and governance decision logs.

Typical format and timing: administer these assessments online and timed, most commonly 15 to 30 minutes, with objective scoring against a benchmark or norm group. Consider offering short, ungraded practice items first so the candidate can get comfortable with the interface, and some platforms use adaptive testing that adjusts item difficulty based on the candidate's previous answers. Score for a breakdown of speed versus accuracy rather than a single figure, and let the candidate know in advance that working carefully and steadily matters as much as working quickly.

For an enterprise architect, cognitive assessment matters because the role is fundamentally about structured thinking under complexity. The role holder is expected to take a strategic view across all architectural domains, portfolios and programmes; to spot inconsistencies between 'as is', 'to be' and transitional states; to trace interdependencies through the organisation's ecosystem; and to prioritise changes that enable delivery at pace. Every one of those duties is, at its core, a cognitive operation: pattern recognition, logical deduction, error checking, prioritisation, and problem solving. A well-designed cognitive assessment for this role simply isolates these operations and measures them directly.

### What it measures

The dimensions of a cognitive assessment map closely onto the skills in the role profile:

- **Enterprise architecture**: turning an organisation's goals into clear objectives requires logical decomposition — breaking a broad ambition into ordered, testable steps. Cognitive items test exactly this: given a goal and a set of constraints, can the candidate deduce the valid sequence of actions?
- **Making architectural decisions**: identifying and addressing architectural risks across business, data and security domains depends on error checking and inference. Items present decision records, dependency tables or principle sets containing subtle contradictions for the candidate to find.
- **Problem definition and shaping**: framing a problem so a solution can be created is pattern recognition applied to messy information. Items ask the candidate to identify which problem statement correctly captures a scenario, or which option set is logically complete.
- **Architect for the whole context**: tracking emerging internal and external issues over time is trend and pattern detection. Items may show sequences of events, incident logs or horizon-scanning summaries and ask what pattern they reveal.
- **Strategy design**: using architectural principles, patterns and constraints appropriately is rule application — a classic deductive reasoning task. Items require the candidate to apply a stated principle to a novel case and identify which conclusion validly follows.
- **Prioritisation for delivery at pace**: the duty to identify priorities for change is tested through ordering and scheduling puzzles built from roadmaps, dependencies and capacity constraints.

### Practice questions

Present each question to the candidate before revealing the answer. Allow around 90 seconds to 3 minutes per question for this difficulty range, and apply the same time allowance to every candidate.

#### Question 1 (easy) — Applying an architectural principle

An organisation has established the architectural principle: "Reuse before buy, buy before build." A delivery team needs a document-management capability. The following options exist:
...
**Explanation:** The principle establishes a strict order of evaluation: reuse first, then buy, then build. Option A is the reuse candidate — an existing, already-licensed platform within the organisation. It must be evaluated first, regardless of the fact that Option B offers a higher functional fit. The principle does not say reuse must always win; it says reuse must be considered first. This distinction — between an order of evaluation and a guaranteed outcome — is exactly the kind of precise rule-reading that cognitive assessments reward, and that a strong candidate's answer demonstrates whenever they are recommending reuse, sustainability and scalability to achieve value for money.
...
**Explanation:** Parallel running requires both systems to be operational at the same time so outputs can be reconciled. T3 decommissions the legacy system in Q3, yet T4 schedules parallel running of that same system in Q4 — after it no longer exists. The sequence is internally contradictory: T4 must come before T3. Option 1 is a plausible-sounding but unsupported generalisation, and option 3 reverses a sensible order. Spotting sequence contradictions in transition states is a core part of owning 'as is', 'to be' and transitional architectures — this kind of artefact is used here because enterprise architects genuinely review such roadmaps.
...
**Explanation:** Point-to-point incidents roughly quadrupled (8 to 33) while the interface count grew only about 10% — incident growth is wildly out of proportion to estate growth, indicating the style itself scales badly (each new point-to-point connection multiplies interaction complexity). By contrast, gateway-managed incidents stayed flat (6–7) despite 40% estate growth, indicating that style absorbs growth well. Option 1 confuses incident data with build-rate causation; option 3 introduces cost data that was never given; option 4 contradicts the evidence. This question mirrors the horizon-scanning duty of the role: identifying emerging trends, separating signal from noise, and drawing only the conclusion the data supports.

#### Question 5 (moderate) — Logical deduction from principles

A principles catalogue contains three statements:
...
Which initiative should be recommended?
...
Capability maturity reviews score capabilities from 1 to 5. Over four assessment cycles, three capabilities scored:
...
**Explanation:** Integration has risen one level per cycle (2→3→4) under continuous investment, so cycle 4 brings it to 5. In cycle 5, the stated ceiling applies: no capability can exceed level 5, so it remains at 5 even with continued investment. Option 3 ignores the explicit constraint; option 2 misreads the series (the "?" is cycle 4, which follows the third value of 4). The underlying skill is disciplined extrapolation: continue a pattern only as far as the stated rules allow, then let constraints override the trend. In practice, this is how an enterprise architect forecasts capability roadmaps honestly rather than optimistically.

#### Question 11 (challenging) — Standards consistency check

Four statements appear across an organisation's standards library:
...
- C4: At most two platforms may be operated.
...
A technology radar tracks each product through the lifecycle stages: Assess → Trial → Adopt → Contain → Retire. A product's history reads: Assess (2021), Trial (2022), Adopt (2023), Contain (2025). A colleague proposes moving it back to "Adopt" in 2026 because a new vendor version has been released. According to the lifecycle model as stated, which reasoning is soundest?
...
### What a strong candidate's approach looks like

- **Fluency with real artefacts.** A candidate who has interrogated a real roadmap, ADR log or principles catalogue — asking what depends on what, and which statements could contradict each other — tends to find these items straightforward, because the assessment measures exactly those muscles.
- **Spotting the contrapositive.** Many of the hardest deduction items (Questions 5 and 8) hinge on reasoning backwards from a rule: if "all X must Y", then anything that is not-Y cannot be X. A strong candidate applies this reflexively rather than working it out from scratch each time.
- **Applying stated rules over personal experience.** A seasoned architect carries strong intuitions, but in this assessment the stated rule always wins (see Question 6). Watch for candidates who read decision criteria as carefully as a contract clause, rather than substituting their own weighting.
- **Strategic time management.** A strong candidate treats the test like a portfolio: investing first where the return is certain, answering the questions they can solve quickly, flagging the multi-constraint puzzles, and returning to them.
- **Calm, systematic reading.** These items reward calm, systematic thinking over speed. A rushed first read that misses one word ("without exemption", "sequential", "at most") costs more time than a careful read would.

### Common candidate pitfalls

- **Overclaiming beyond the evidence.** Choosing a conclusion that is plausible in professional experience but not entailed by the given facts. Assessors deliberately include "sensible but unsupported" options.
- **Substituting judgement for rule application.** When a prioritisation or decision rule is stated, substituting personal weighting for the rule's strict order.
...
- **Assuming the artefact is correct.** Several question types (Questions 2 and 7) reward finding the flaw. Approach every roadmap, ADR and standard in the test the way a governance review would: sceptically.

## Workplace job-specific numeric reasoning assessment

### About this assessment

A workplace job-specific numeric reasoning assessment evaluates a candidate's ability to analyse, interpret, and make sound decisions using numerical data drawn from the role. It mimics the data-handling demands of enterprise architecture, focusing on practical business mathematics — percentages, ratios, cost comparisons and capacity figures — rather than abstract formulae. Draw the question inputs from the tables and figures an enterprise architect actually encounters: portfolio budgets, licensing schedules, total cost of ownership comparisons, hosting capacity plans, benefits projections, and sustainability metrics.

Typical format and timing: deliver these assessments online, strictly timed, and calculator-friendly — provide or allow an on-screen calculator, because the point is interpretation, not mental arithmetic. Present a series of data sets (a table or chart) each followed by two to four questions, with roughly one to two minutes per question. Accuracy under time pressure is the game: quick, correct extraction of the right figures from a busy table matters more than mathematical sophistication.

Why does this matter for the role? An enterprise architect guides the organisation to make business, technology and data decisions that achieve value for money and reduce risk. That guidance is only credible when it is numerate. A recommendation of reuse over rebuild rests on a cost comparison. Advice on sustainability and scalability reasons about capacity growth curves and consumption figures. Presenting a roadmap to an investment board requires fluency in programme budgets, benefit profiles and run-cost trajectories. A numeric reasoning assessment for this role measures whether a candidate can do this reliably, quickly, and without being misled by the way data is presented.

### What it measures

The assessment dimensions map to the role profile skills like this:

- **Commercial perspective**: understanding sourcing strategies and commercial processes requires comparing contract costs, licence models (per-user versus consumption-based), and total cost of ownership across options. Items are built on supplier pricing tables and contract schedules.
- **Enterprise architecture** and **strategy design**: roadmaps and target states carry cost and capacity numbers. Items test whether the candidate can project run costs across transition states, calculate cumulative savings, and check whether a benefits profile actually adds up.
...
Provide an on-screen calculator where the real assessment would allow one. The explanations below show the arithmetic in full, so you can check a candidate's working against it when scoring.

#### Question 1 (easy) — Percentage of portfolio spend

An architecture portfolio dashboard shows annual spend across four domains: business change £2.4m, technology £5.1m, data £1.8m, and security £0.7m. What percentage of total portfolio spend goes to the data domain, to the nearest whole per cent?
...
**Explanation:** Transition state 1: £8.0m × (1 − 0.15) = £8.0m × 0.85 = £6.8m. Transition state 2: £6.8m × (1 − 0.10) = £6.8m × 0.90 = £6.12m. The classic trap is adding the percentages (15% + 10% = 25%) and computing £8.0m × 0.75 = £6.0m — distractor 1. Sequential percentage changes compound; they do not add, because the second reduction applies to a smaller base. For a role that owns roadmaps "from a business, technology and data perspective, including 'as is', 'to be' and transitional states", compounding savings correctly across states is the difference between a credible benefits case and one that unravels at the investment board.

#### Question 6 (moderate) — Weighted option scoring

An options appraisal weights three criteria: strategic alignment 50%, cost 30%, delivery risk 20%. Two options score out of 10 on each criterion:
...
**Explanation:** Option A: (8 × 0.5) + (5 × 0.3) + (6 × 0.2) = 4.0 + 1.5 + 1.2 = 6.7. Option B: (6 × 0.5) + (9 × 0.3) + (7 × 0.2) = 3.0 + 2.7 + 1.4 = 7.1. Comparing: 7.1 > 6.7, so Option B wins under the stated weightings, despite Option A's stronger strategic alignment. This question is constructed to catch a specific error: computing both scores correctly and then selecting the option intuitively preferred (the strategically aligned one) rather than the one the weighted model actually favours. In weighted scoring, the model's answer is the model's answer; if a candidate believes strategic alignment deserves more weight, the professional move is to challenge the weightings openly at governance — not to misreport the calculation. A strong answer shows the arithmetic, then makes the argument about the weights separately.

#### Question 7 (moderate) — Ratio reasoning for team capacity

An architecture community has 6 enterprise-level architects, 15 solution architects and 24 technical architects. Best practice in the organisation suggests a support ratio of no more than 1 enterprise-level architect to 8 other architects. Is the current ratio within tolerance, and what is it?
...
**Explanation:** Compound growth: £40,000 × (1.05)^12. Compute (1.05)^12 ≈ 1.796. So £40,000 × 1.796 ≈ £71,800 ≈ £72,000 — an increase of roughly 80%. The headline trap is linear thinking: 5% × 12 = 60%, giving distractor 1 (£64,000). Compounding at 5% monthly nearly doubles a cost in a year — this is why consumption-based commercial models need active architectural management, and why sustainability and scalability recommendations must distinguish linear from compound growth. Where a candidate cannot compute powers quickly, the doubling heuristic offers a shortcut: at 5% per period, doubling takes about 14 periods (rule of 70: 70 ÷ 5 = 14), so 12 months lands just short of doubling — enough to select 80% over 60% with confidence.
...
**Explanation:** Work through each allocation: strategic change minimum = 40% × £2.5m = £1.0m. Community development = 12% × £2.5m = £300,000. Consultancy maximum = 20% × £2.5m = £500,000. Committed so far: £1.0m + £0.3m + £0.5m = £1.8m. Remaining for operational work: £2.5m − £1.8m = £700,000. The question demands careful tracking of "at least", "exactly" and "no more than": to maximise the remainder, the "at least" item is set to its floor, and the "no more than" item — stated as being at its maximum — is fixed at its ceiling. Constraint words are doing all the work, exactly as they do in real budget discussions with finance colleagues, where commercial perspective and precision with allocation rules protect the operational capacity teams depend on.

#### Question 14 (moderate) — Comparing sourcing day rates

The candidate is advising on sourcing for an eighteen-month architecture workstream requiring the equivalent of 2 full-time architects. Options:
...
**Explanation:** Work each option over 18 months (1.5 years) for 2 architects. Contractors: £750 × 220 days = £165,000 per architect per year; for 2 architects over 1.5 years: £165,000 × 2 × 1.5 = £495,000. Consultancy: £700,000 fixed, no scaling needed. Permanent: annual employment cost £95,000 × 2 × 1.5 = £285,000, plus recruitment £15,000 × 2 = £30,000, giving £315,000. Comparing: £315,000 < £495,000 < £700,000, so permanent hires are cheapest. Distractor 2 doubles the contractor figure by applying the 2-architect multiplier twice; distractor 3 forgets the recruitment cost; distractor 4 miscomputes the permanent salary line. The reliable method is a small grid — option by option, cost line by cost line, each multiplied by the correct headcount and duration exactly once. Note also what the numbers alone do not decide: an 18-month workstream may not justify permanent posts if the need then disappears, contractors carry engagement-rule and knowledge-retention considerations, and the consultancy price may include deliverable risk transfer. Understanding when each sourcing strategy applies — not just which is cheapest — is the commercial perspective the role profile names; the arithmetic is the entry ticket to that conversation.

### What a strong candidate's approach looks like

- **Fluency with percentages, ratios and compounding.** These three operations cover the vast majority of numeric items at this level. A candidate who has kept this fluency sharp — recomputing percentage changes, reversing percentages, compounding growth — moves through these items quickly.
- **Familiarity with real financial artefacts.** A candidate used to interrogating a genuine business case, licensing schedule or cloud billing report — the five-year TCO, the break-even point, the compound growth rate — tends to find test data feels routine rather than abstract.
- **Identifying the denominator first.** Before computing any proportion, a strong candidate establishes "out of what?" Changed denominators (Question 8) and partitioned bases (Question 12) are the two most reliable traps at senior level.
- **Using the answer options as a check.** The options reveal the required precision and can flag an extraction error: a figure that is not close to any option is worth a second look at the table before recalculating.
- **Estimating before computing.** A ten-second estimate (rule of 70, rounding to friendly numbers) catches order-of-magnitude errors and rejects distractors quickly.
- **Calm about the calculator.** It is normally provided. The test measures interpretation, not arithmetic heroics, and a senior professional already interprets numbers like these weekly — nerves about mental arithmetic are not informative of the skill being tested.
...
- **Adding sequential percentages.** Two successive reductions of 15% and 10% are not 25% (Question 5). Compounding errors are the most common senior-level mistake, because the arithmetic looks beneath a senior professional's dignity — until it isn't.
- **Grabbing intermediate values.** Distractors are frequently numbers legitimately computed on the way to the answer (Question 2) — watch for a candidate who stops one step early and selects an intermediate figure.
...
- **Time-sink questions.** One brutal multi-stage question can consume five easier questions' worth of time. A candidate who banks the accessible marks first and returns to a hard question later, rather than the reverse, typically scores better.
- **Forgetting the question's units or timeframe.** Computing an annual figure when the question asks monthly, or a total when it asks a difference. A careful candidate re-reads the final sentence of the stem before answering.

## Workplace job-specific verbal reasoning assessment

### About this assessment

A workplace job-specific verbal reasoning assessment evaluates how well a candidate understands, analyses, and draws correct conclusions from written business information. It mirrors the exact reading demands of the role: dense strategy papers, architecture principles, government technology standards, governance board minutes, supplier correspondence, and policy documents. The defining discipline is fact-based logic — the candidate must answer based strictly on the text provided, setting aside their own professional knowledge, however extensive.

Typical format and timing: present a passage of role-relevant text followed by a series of statements. For each statement the candidate chooses **True** (the passage logically supports it), **False** (the passage logically contradicts it), or **Cannot Say** (the passage provides insufficient information either way). Some tests add multiple-choice comprehension questions about the passage's main argument or a specific clause. Timing is tight — often less than a minute per question — to simulate workplace reading under deadline pressure.

Why does this matter for an enterprise architect? The role profile puts communication at its heart: leading the communication of complicated, complex or risky architecture topics with technical and non-technical stakeholders, and establishing architectural principles, policies and standards — documents whose exact wording carries obligations. Misreading "should" as "must", or treating an implication as a statement, has real consequences: a governance decision built on a misread standard, a stakeholder commitment inferred from an email that never made it, a principle applied beyond its stated scope. Verbal reasoning assessments measure precisely this precision. They also measure the flip side: the restraint not to import outside knowledge. An experienced architect often knows more than a passage says — this assessment rewards a candidate who can quarantine that knowledge and reason only from the text, exactly as the role requires when assuring that a decision matches what a standard actually requires rather than what everyone assumes it requires.

### What it measures

- **Architecture communication**: leading communication of complex topics starts with receiving text accurately. The True/False/Cannot Say format directly measures whether a candidate extracts what a document actually commits to — essential to managing stakeholder expectations based on written positions.
- **Establishing principles, policies and standards**: these artefacts are legal-adjacent texts where "must", "should", "may", and "without exemption" each carry distinct force. Items are written in standards language, testing whether the candidate tracks modal verbs and scope clauses.
- **Making architectural decisions** and **architectural governance**: decision records and board minutes must be read for what was decided versus what was discussed. Passages mix decisions, options and opinions, and statements probe whether the candidate kept them separate.
- **Commercial perspective**: supplier letters and contract extracts test whether the candidate can identify obligations, conditions and exclusions — the reading skill underlying sourcing strategy.
- **Architect for the whole context** and **horizon scanning**: analytical passages about industry trends test whether the candidate distinguishes the author's evidence from the author's speculation — the core skill of honest horizon scanning.

### Practice questions

Instruct the candidate to judge every statement strictly on the passage's wording, setting their professional knowledge outside the room.
...
**Explanation:** The passage explicitly says "the board agreed that a decision would be deferred until a revised cost model is presented". A deferral is a decision not to decide — which directly contradicts the claim that the board decided to adopt Option 2. The distractor's power comes from "Option 2 was preferred by a majority": preference expressed in discussion is not a decision minuted as such. Reading minutes for what was *decided* versus what was *discussed or preferred* is a precise skill exercised in every governance and assurance engagement, and it is a favourite of test writers because the two are so easily conflated at speed.
...
**Explanation:** The letter says prices "will be adjusted in line with our standard indexation clause". Adjustment under indexation is usually upward in practice — but the passage does not state the direction, and an indexation clause could in principle produce no change or even a decrease depending on the index. "Adjusted" is not "increased". Commercial experience suggests that supplier indexation usually means a rise; the item tests whether a candidate can hold that knowledge apart from what the text commits to. This is exactly the discipline the role needs when summarising contractual positions for senior stakeholders: report what the supplier has actually committed to in writing, and flag expectations separately as judgement.
...
**Explanation:** The passage is built almost entirely of conditionals and projections: analysts *project* majority adoption; *if* the projection is accurate *and* the department *wishes* to be in the majority, *then* work must start by mid-2026. Nowhere does the passage state that the department must, will, or has decided to establish the function — the "need" in the statement only exists inside an unfulfilled conditional. Moreover, the final sentence actively undermines the projection's reliability. The statement is not contradicted (the department might well decide to do it), so not False; it is not supported as a fact, so not True. Cannot Say. Honest horizon scanning — a duty named in the role profile — lives exactly here: presenting trends and their conditions without letting a projection harden into a commitment.
...
**Explanation:** Option 1 assembles the three stated elements of the regime accurately: the sole granting body ("only by the Design Authority"), the recording requirement ("recorded in the architecture decision log together with a remediation date"), and the time limit ("lapse automatically at the remediation date unless renewed"). Option 2 misattributes the granting power to the enterprise architecture function — whose stated role is pre-design consultation where no reference architecture exists — and misapplies the fortnightly cadence, which describes meetings, not reviews of exemptions. Option 3 contradicts "time-limited" and "lapse automatically". Option 4 inverts the passage's logic: exemptions apply to *published* reference architectures; where none exists there is nothing to be exempt from, and a different rule (consultation) applies. Summary questions like this reward reassembling scattered clauses into a whole — the same synthesis performed when briefing a board on what a standard actually requires, rather than reading it aloud clause by clause.

### What a strong candidate's approach looks like

- **The Cannot Say reflex.** Most candidates — especially experienced professionals — err towards True or False because they know the subject matter. A strong candidate asks one question of every statement: "Where in the passage is this stated or contradicted?" If they cannot point to the words, they answer Cannot Say.
- **Reading modal verbs like a standards author.** An enterprise architect already writes principles and policies; a strong candidate brings that drafting eye to reading, noticing every "must", "should", "may", "only", "unless" and "beyond" — in this assessment they are the whole game.
- **Separating decisions from discussion.** When a passage is minutes or a decision record, a strong candidate distinguishes what was decided, what was preferred, what was raised, and what was actioned — the boundaries statements are built to probe.
- **Matching time periods and scopes exactly.** A strong candidate checks that a statement's timeframe, population and condition are the same as the passage's before answering. "Beyond the contract year" is not "during the contract year"; "whichever option" is not "only Option 2".
- **Grounding in real documents.** A candidate practised at defending True/False/Cannot Say statements about a government technology standard, a supplier letter or a set of board minutes from the text alone tends to bring the same discipline to the assessment.
- **Pacing by the statement, not the passage.** A strong candidate skims the passage once for structure, then works statement by statement, returning to the exact sentence each one touches — rather than reading the passage exhaustively first, the classic time-management error.

### Common candidate pitfalls

- **Importing professional knowledge.** The most common failure for senior candidates: they know how indexation clauses, governance boards and analyst projections behave in real life, and that knowledge quietly fills the passage's gaps rather than the text answering it alone.
...
- **Half-right statements.** Distractors weld a true fragment to a false one (Question 1). A careful candidate verifies every clause of the statement, not just the recognisable part.
...
Why does this matter for the role? Enterprise architecture is judged less by artefacts than by influence. The role profile is explicit: leading and influencing cross-cutting change, consulting and supporting collaboration across the business, communicating complicated and risky topics to senior stakeholders, developing the architecture community, and guiding the organisation's decisions through governance rather than authority. Nearly every one of those duties is a judgement call about people, timing, escalation, and candour. A situational judgement assessment simply compresses those calls into scenarios: a director bypassing governance, a supplier pressuring a decision, an architect community losing faith, a delivery team about to breach a principle for a deadline. How a candidate chooses to act — and what they choose never to do — reveals how they will actually operate in the role.

### What it measures

- **Architecture communication**: scenarios test whether the candidate adapts their message to the audience, manages expectations honestly, and advocates for teams to senior stakeholders without burning trust.
...
- **Making architectural decisions** and governance: scenarios probe whether the candidate escalates through the right channels, keeps decisions transparent, and balances pace against managed risk.
- **Architect for the whole context**: dilemmas pit the candidate's immediate programme's interests against wider organisational objectives, testing whether they act on the bigger picture and influence colleagues across the organisation.
...
- C: Let the contract proceed — the director owns the delivery risk — but record the objection in the decision log.
...
A senior stakeholder the candidate has been cultivating for months finally offers enthusiastic sponsorship — for a data-platform initiative that duplicates a cross-government capability the roadmap commits to adopting next year. Accepting would deliver visible value quickly and cement the relationship; declining risks the stakeholder's disengagement.
...
Attendance at the candidate's architecture community of practice has halved over six months. A trusted colleague tells the candidate privately: "People stopped coming because it became a broadcast channel — an hour of enterprise team slides, no discussion, nothing they can use."
...
**Explanation:** This is community collaboration and communication in one scenario: a compliance issue that must be surfaced, inside a person and environment the assessor's own role is responsible for developing. C surfaces the flaw in the session — it cannot be left standing, since the community would otherwise learn that a policy breach passed review — but does so as a question the architect can engage with, preserving their standing and modelling how architects challenge each other. The private follow-up converts the moment into development. A gets the compliance right and the environment wrong: a thorough public correction of a nervous first-time presenter teaches the community that presenting is dangerous, and attendance problems follow. D rescues the design while erasing the designer — efficient, humiliating, and a lost learning opportunity. B is least effective because it fails on every axis: the flaw goes unchallenged in front of the community (compliance failure), the architect learns nothing in the moment, and the first they hear of it is via their line manager — which converts a technical correction into a reputational event. Kindness that routes bad news through hierarchy is not kindness.

#### Question 9 (challenging) — The minister's briefing and the inconvenient risk

The candidate is contributing to a briefing for senior officials supporting a ministerial announcement about a major digital transformation. The draft states the legacy system replacement "is on track for completion next year". Their analysis shows a material risk: a critical data migration dependency is unresolved and could slip completion by up to a year. The programme director asks them to "keep the briefing positive — the risk is being managed."

Possible actions:

- A: Insist the briefing include the candidate's full risk analysis with all supporting detail, or their name comes off the work.
- B: Accept the director's framing — the risk is indeed being managed, and briefings are their call.
- C: Propose wording that is both accurate and proportionate — for example, "on track, subject to a known migration dependency that is being actively managed" — and if the director refuses any acknowledgement of the risk, escalate the concern through the candidate's professional line before the briefing is finalised.
- D: Send the risk analysis directly to the senior officials, bypassing the director.

**Most effective: C. Least effective: B.**

**Explanation:** Briefings that inform ministers sit at the sharp end of public sector transparency: officials advising ministers are entitled to an accurate picture. C does the professional work of finding language that is truthful without being alarmist — "positive" and "accurate" are usually reconcilable with careful drafting, which is precisely the architecture-communication skill of adapting the message to the audience — and it establishes a clear line: accuracy is not negotiable, and if it cannot be achieved collaboratively, the professional escalation route exists for exactly this. A confuses accuracy with completeness: a ministerial briefing does not need the candidate's full analysis, and making it an ultimatum about the candidate's name personalises what should be about the reader's need. D torpedoes trust and due process in one move; bypassing the director should be a last resort after C's escalation route, not a first response. B is least effective: "the risk is being managed" is the director's assertion, not the candidate's analysis, and acquiescing means senior officials brief a minister on a picture known to be materially incomplete. When transparency and hierarchy collide, the enterprise architect's obligation runs to the accuracy of the enterprise picture.

#### Question 10 (moderate) — The reuse recommendation nobody wants

The candidate's analysis shows a sister department's grants platform could be reused for a new service at roughly 40% of the cost of the delivery team's preferred build. The delivery team resists: "Their platform is clunky, we didn't design it, and reuse makes us dependent on another department's roadmap."
...
**Explanation:** Horizon scanning is a named duty of the role, but so is working through collective governance — and this scenario tests what a senior professional does when the two collide. C holds both: the group's decision stands (collective governance means accepting outcomes the candidate argued against), while professional judgement continues to operate in the open — monitoring evidence, sharpening the case with organisation-specific use cases (the usual weakness of "hype" arguments in both directions), and returning through the front door when the facts warrant. That is how being right eventually becomes being effective. A confuses accepting a decision with abandoning professional judgement; if the technology matters, dropping surveillance entirely is a whole-context failure. D spends escalation capital on a disagreement about a radar entry, and "complacent" converts a technical disagreement into a personal one. B is least effective: a covert evaluation defies a collective decision in secret, and its findings are unusable — favourable results reveal the defiance; unfavourable ones were not worth the trust spent. Influence-based roles cannot afford secret work.

#### Question 12 (moderate) — The stakeholder who heard a promise

A director tells colleagues that the candidate "committed" the enterprise architecture team to delivering an integration design for their programme by month end. What the candidate actually said, in a corridor conversation, was that the timeline "sounded feasible, subject to checking the team's capacity". The team cannot deliver it by month end without dropping higher-priority work.

Possible actions:

- A: Deliver it anyway by quietly deprioritising the other work — protecting the relationship matters most.
- B: Contact the director promptly and directly: clarify what was actually said, take their share of responsibility for the ambiguity, present the real capacity picture and options (later date, reduced scope, or a re-prioritisation decision made openly with the affected parties), and confirm the outcome in writing.
- C: Email the director's colleagues correcting the record, so the misstatement doesn't stand.
- D: Have the team lead tell the programme that no commitment exists.

**Most effective: B. Least effective: C.**

**Explanation:** This is expectation management — a named element of the architecture-communication skill — in its most common real form: a hedge heard as a promise. B contains every necessary move: it goes to the source rather than around them; it owns the communication failure ("subject to checking capacity" was said, but corridor conversations invite exactly this misunderstanding); it replaces the false commitment with real options rather than a bare refusal; and it closes the loop in writing, which is how corridor ambiguity is prevented from recurring. A rewards the misunderstanding by silently taxing higher-priority work — the whole-context failure of solving a local relationship problem with an enterprise resource; and D sends a subordinate to deliver the correction, which reads as both evasive and dismissive. C is least effective because correcting the record laterally — to the director's colleagues, without speaking to the director first — publicly contradicts a senior stakeholder and converts a fixable misunderstanding into a credibility contest. Expectations are managed with the person who holds them.

### What a strong candidate's approach looks like

- **Anchoring on values, not personalities.** A strong candidate's answers express the public sector digital values: user needs first, transparency, collaboration, accessibility and inclusion, and value for public money. When two options both seem plausible, the one that better serves these values is usually the keyed answer.
- **Engaging before escalating.** At this level, the strongest answers typically seek to understand stakeholders' drivers first, use governance channels as enablers rather than weapons, and hold escalation in reserve for when engagement fails. First-move escalation and first-move capitulation are both usually signs of a weaker answer.
- **No hidden transparency costs.** Covert action — quiet delays, secret evaluations, unannounced non-enforcement, undisclosed briefings — is almost always the least effective option, however practically appealing. Watch for candidates who choose an option that only works while nobody knows about it.
- **Reading the question format carefully.** "Most effective" and "least effective" are judgements about outcomes, not intentions; a well-meant option can be least effective. In ranking formats, the best and worst are usually clearer than the middle, so give particular weight to how a candidate handles the extremes.
- **Grounding in real experience.** A candidate who can recall real dilemmas from their career — bypassed governance, a deadline versus a standard, a community that stopped attending — and reflect on what worked, what they would do differently, and which value was really at stake, tends to give richer answers than one reciting theory.
- **Answering as the role, not as the hero.** The strongest candidates describe an enterprise architect who strengthens institutions — governance, communities, decision processes — rather than one who personally saves every situation. Options where systems get stronger usually beat options where the candidate personally wins.
...
- **Answering as the organisation is suspected to behave, rather than as its values require.** Situational judgement tests are keyed to the espoused values and competency framework. Cynical answers — "escalation is what actually works here" — cost marks even where the cynicism is locally accurate.

## Conclusion

You now have a complete, four-part assessment for the enterprise architect role level: cognitive ability, testing logical deduction, error checking and prioritisation on roadmaps, decision records and standards; numeric reasoning, testing budgets, licence models, total cost of ownership, risk exposure, and capacity figures; verbal reasoning, testing the discipline of answering strictly from the text of principles, minutes, supplier letters and horizon-scanning briefings; and situational judgement, testing realistic dilemmas involving directors, delivery teams, suppliers, governance boards and the architecture community.

**Scoring.** Work through the candidate's responses against the worked answers and explanations above, which serve as your answer key. For the cognitive, numeric and verbal sections, mark each item against its stated correct answer. For situational judgement, compare the candidate's "most effective" and "least effective" choices, or their ranking, against the keyed answers, and note where their reasoning — if you ask for it — aligns with, or departs from, the explanations given. A single wrong answer rarely tells you much on its own; look instead for a pattern across a section, and note where a candidate's explanation reveals sound reasoning that happened to land on the wrong option, or the reverse.

**Debrief.** Once scoring is complete, talk the candidate through their results. Share where their responses were strong, and where they diverged from what the explanations describe as a strong answer, treating this as a genuine development conversation rather than a verdict. For situational judgement especially, a debrief that explores why a candidate chose an option is often more informative than the choice itself, and it gives the candidate something to take away regardless of the outcome.

**Records and consistency.** Keep a record of which items were administered, under what time limit, and how each candidate scored, so that every candidate for this role level is assessed on the same basis. Use the same items and the same time allowances across candidates; changing the material between candidates undermines any comparison between them. File the completed record alongside the rest of the hiring or promotion evidence, and never release the worked answers and explanations to a candidate before they complete the assessment.
