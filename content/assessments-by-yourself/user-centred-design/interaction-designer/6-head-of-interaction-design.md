...
Welcome. This guide is written for you as a head of interaction design in the UK Government Digital and Data profession — an expert practitioner with broad industry experience who defines and assures best practice, influences both design and organisational strategy, collaborates with counterpart colleagues across government, and focuses on ensuring the right conditions and environment for designers to work effectively. That last item distinguishes your role from every level below it: your primary output is no longer design, nor even the assurance of design, but the conditions under which good design becomes the normal result.
...
Four features of the role shape everything that follows. First, you are accountable for design quality produced by people you did not train, on services you have not seen, judged from outputs rather than from the work behind them — which makes diagnostic reasoning at a distance a core competence. Second, you work at the level of shared assets and systems: design systems, component libraries, standards, assurance routines, tooling and the conditions of work. Decisions at that level are paid for many times over, in maintenance, in the expectations they set, and in the accessibility characteristics they propagate across every adopting service. Third, you influence people who substantially outrank you, in forums where design is one input among many; your influence rests on your evidence being unassailable and your judgement being trusted. Fourth, you build capability: the practice you leave behind matters more than any component you assure.
...
2. A numeric reasoning assessment — weighted aggregation, funnel and cohort data, sampling adequacy, conformance and business case claims, and the interrogation of figures already embedded in board-level decisions.
...
Commit to an answer before reading, and attend particularly where you were quick and sure.
...
The first is reasoning at a distance. You almost never see the work; you see an output, a component, a claim in a board paper, a summary of a summary, and must judge from visible traces whether the reasoning underneath holds.

The second is that the interesting questions concern mechanisms. When something goes wrong repeatedly, the informative feature is the distribution of failures. Concentrated in one directorate under one condition among experienced people? That is a process telling you it cannot be complied with.

The third is the multiplier. A component adopted by fifteen services carries its defects fifteen times and its virtues fifteen times, and is far harder to change than to introduce. Several items ask you to weigh a decision by how many times it will be paid for.
...
**Explanation:** Work through all six. Problem, keyboard behaviour and date are present. "Tested and works" is a statement about assistive technology behaviour — thin, but it addresses the requirement, so it is met at a minimum level. "When not to use" is absent, and known limitations are absent. Two unmet, giving B. Option C typically comes from rejecting "tested and works", which is a defensible design judgement and the wrong assurance judgement — the discipline is to apply the standard as written, and if the standard permits an answer that thin, the standard is what needs changing. At your scale the pattern matters more than the instance: "when not to use" and "known limitations" are the two most commonly omitted fields in component documentation everywhere, and their absence is precisely what produces components deployed in situations they were never designed for. That points at the template and the review prompt, not at this entry.

**Question 2 (easy) — Deduction from a governance rule**

Your standard states: "A custom component may enter a live service only with design assurance sign-off, unless it replaces an existing custom component on a like-for-like basis and has been assessed as low risk." A directorate reports shipping one last month without sign-off. Which must be true?
...
**Explanation:** A conditional with a stated exception, plus facts silent on the exception, licenses only the disjunction. Options A and B each assume a branch. Option D prescribes an action rather than stating what must be true, and the question asks the latter — worth noticing, because at this level a sensible action is frequently offered as a distractor in a logic item and may well be what you would do. Only C holds. Note the compound exception: like-for-like *and* low risk. Partial satisfaction is not satisfaction, and it is the most common misreading in governance conversations. As the person who owns this standard, your opening move is to establish which route was taken, framed as an enquiry — an accusation you have to withdraw costs more than the day it takes to ask, and it costs it in a currency you cannot easily replace.

**Question 3 (moderate) — Reading a study from its output**

An output states: "Users find the new autocomplete easy — all 24 participants completed the task without difficulty." It notes the facilitator demonstrated the component first, participants came from the departmental panel, and all used a laptop with a mouse. What is the most important observation?
...
**Explanation:** Value of information is the right frame, and item 1 carries a multiplier the others lack. A pattern decided once and reused eight times embeds a good or bad decision eight times, and the cost of changing it rises with every adoption — after a year, changing it means coordinating eight release schedules, which is why patterns are so much easier to get right than to fix. Item 2 affects more users today but has been stable for months. Item 3 is weakest despite sounding prudent: signed-off designs five weeks from launch means findings arrive with nowhere to go. Item 4 has eight months, and at your level the profile trap takes exactly this form — spending review work attracts attention, and attention is not decision leverage. Saying so to a director general without sounding dismissive is the harder half of the skill.
...
**Explanation:** The synthesis that adds value identifies a shared mechanism and reframes the unit of the problem. Five services showing difficulty at the same step, with a discovery pointing at document availability and contact centre volume confirming scale, indicates something structural. Option B also draws the consequence, and its second clause is what makes it a head's answer: five local workarounds are not merely wasteful but actively harmful, because each will be partial in a different way and the excluded population will remain excluded across all five, in variations nobody can then fix centrally. Your role names ensuring design becomes part of the development of organisational strategy, and this is what supplies material for that. Option A describes without synthesising. Option C is true and strategically useless. Option D misses the pattern.

**Question 6 (moderate) — Scope of a claim heading for a standard**

A proposal for a new organisational pattern argues that "users expect to save and return at any point", supported by four studies all of services taking more than two weeks. What is the most useful intervention?
...
**Explanation:** The evidence is real and the sentence built on it reaches further than the evidence goes — the most common failure in synthesis, and unusually consequential here because the claim is destined to become an organisational pattern with an implied obligation. Multi-week services supply an obvious reason to expect saving and returning: you cannot finish in one sitting. That may not transfer to a five-minute service, where a save-and-return control adds a decision, occupies space and creates an abandoned-session problem for no benefit. Option B preserves the finding and corrects the scope — and notice that the fix belongs in the pattern's stated applicability, exactly the field Question 1 identified as most commonly omitted. Option A discards something real. Option D imposes an obligation on every team on evidence from one service type. Option C reaches for the expensive remedy before the free one.

**Question 7 (moderate) — Diagnosing a systemic problem**

Eight teams keep building custom components where Design System components would serve. Each has a plausible local reason. What is the strongest diagnosis and response?
...
**Explanation:** Eight teams behaving identically for individually plausible reasons is the signature of a systemic cause, and the plausibility of each local reason is precisely what makes case-by-case challenge exhausting and ineffective — you win each argument and the behaviour continues. Option B names the three realistic candidates, and the point is that they imply entirely different remedies: contributing the missing variant, improving discoverability, or reducing adoption friction, which is usually a tooling and documentation problem rather than a design one. Diagnosing wrongly costs a quarter and the credibility of the next attempt. Option A stops the day you are busy. Option C adds a gate without addressing why teams route around the existing path, producing a queue and compliance theatre. Option D accepts eight sets of accessibility defects and eight maintenance burdens.
...
**Explanation:** Apparent contradictions between sound studies are usually context differences in disguise, and the diagnostic move is to ask what each participant was actually doing. Someone entering a remembered date of birth is transcribing a value they hold; someone selecting an appointment is choosing among options. Different tasks reward different controls, which is why both findings can be correct. Option B reaches the synthesis, and the synthesis is more valuable than either original finding: it gives every team in the organisation a rule for choosing, which neither study alone could, and extracting and propagating that kind of generalisable rule is exactly what your role exists to do. Option A spends money on a question that dissolves. Option C abdicates the synthesis — "note the inconsistency" is how insight gets filed as a caveat. Option D picks a winner on an irrelevant criterion.
...
The organisation is deciding whether to adopt a third-party component library. Available: an internal audit finding accessibility defects in four components; a supplier claim of full WCAG conformance; two teams reporting faster delivery; and a maintenance cost model. What is your most rigorous contribution?
...
**Explanation:** The pattern is an opportunity to identify a practice, not to grade people. Teams producing consistently better components are almost always carrying a routine — a keyboard pass before anything merges, an automated check in the pipeline, a rule that nothing ships without a screen reader run — and routines transfer in a way that expertise does not. Option B goes and looks, the step almost everyone skips in favour of an assumption. Option A posits a knowledge deficit without diagnosing one, and accessibility training unattached to a routine is among the least effective interventions in the field. Option C is unusable as an inference from two people and misattributes a routine to a pedigree. Option D catches more defects and creates no capacity to prevent them. Your role names iterating and measurably improving design maturity, and a naturally occurring comparison telling you what good looks like in your own context is the best material that work will ever get.
...
- **Scope flaws precisely.** Wholesale condemnation teaches the organisation to stop declaring faults.
- **Weight decisions by reuse.** A pattern used eight times is worth eight times the attention.
...
- **Ask what conformance claims actually cover.** Isolation and defaults, not composition and customisation.
...
- **Applying a standard as you would have written it.** If it permits a thin answer, change the standard.
...
- **Comparing rates between modes of operation** maps to **Designing for everyone**, where you guide organisations to adopt inclusive practices.
- **Judging what a measurement establishes** maps to **Evidence-based design**, where you embed hypothesis-driven design.
- **Presenting figures at defensible strength** maps to **Design communication**, where you gain support from senior leaders.
- **Detecting misleading metrics** maps to **Designing strategically**, where design must inform decisions early — which requires the figures in those decisions to mean what they appear to.

### Practice questions

**Question 1 (easy) — Rate from counts**

Of 12,000 users who reached a page, 3,000 triggered a validation error on one field. What percentage?
...
**Explanation:** 3,000 ÷ 12,000 = 0.25, so 25%, and the answer is B. Estimate first: 3,000 of 12,000 is a quarter. Options A and C come from dividing by 15,000 and 10,000. At your level the more consequential question is whether the field belongs to a shared pattern, because if so the same rate is being produced everywhere the pattern is used, and the value of fixing it multiplies by the number of adopting services rather than being confined to this page. That is the kind of reframe that turns a team-level nuisance into an organisational priority.

**Question 2 (easy) — Drop-off against the right base**

A page is reached by 16,000 users and passed by 12,000. What is the drop-off rate?
...
**Explanation:** The drop-off is 4,000, measured against arrivals: 4,000 ÷ 16,000 = 0.25, giving A. Option B divides by those who continued — the most common error in page analytics, overstating every drop-off. At your level the consequence is not one wrong figure but a wrong organisational picture: if teams compute pages with different denominators, the ranking of where capacity should go is distorted, and you adjudicate that ranking. A single line in your standard specifying the denominator is among the cheapest quality interventions available and one of the few that fixes a whole class of error permanently.

**Question 3 (easy) — Disaggregated rates**

| Group | Users | Completed |
|---|---|---|
| Mouse users | 27,000 | 24,300 |
| Keyboard-only users | 2,100 | 1,050 |
| Screen reader users | 900 | 225 |
...
**Explanation:** Completions total 24,300 + 1,050 + 225 = 25,575, across 27,000 + 2,100 + 900 = 30,000 users, so 25,575 ÷ 30,000 = 85.25%, rounding to 85%. Group rates are 90%, 50% and 25%, giving a 65 point gap. Hence B. Option C mistakes the dominant group's rate for the overall, the characteristic error when one group makes up 90% of the sample — and it is worth noticing how nearly right it feels. That is the point. The overall figure of 85% describes no group here and conceals that screen reader users fail three times in four. A standard that does not require disaggregation by mode of operation has a hole in it shaped precisely like the users least able to complain, and writing that requirement into the standard is worth more than any individual finding you will ever produce.
...
**Explanation:** Convert each rate to counts. Study 1: 40% of 20 = 8. Study 2: 60% of 30 = 18. Study 3: 70% of 10 = 7. Study 4: 80% of 40 = 32. Total 8 + 18 + 7 + 32 = 65, across 100 participants, so 65% and the answer is B. Option A is the unweighted mean of 40, 60, 70, and 80, which is 62.5 and over-weights the two smallest studies at the expense of the 40-participant study that should dominate. Always return to counts, and re-check the total before it leaves your hands — at your level a plausible-looking figure travels on your authority, and your errors have a longer half-life than anyone else's because nobody downstream will question them.
...
**Explanation:** The stem names users who passed identity, so the denominator is 150,000 and the part is 81,000: 81,000 ÷ 150,000 = 0.54, giving B. Option A uses 200,000, option C is the identity-to-upload rate, option D is the upload-to-submit rate. All are true of this funnel; one answers the question. Strategically the funnel shows where capacity belongs: 50,000 lost at identity and 60,000 between identity and upload, against 9,000 at submission. A directorate proposing to redesign submission would need a strong reason, and establishing that in fifteen seconds is what lets you redirect a programme in the meeting rather than a month later.
...
- A) Whether the audit was competent.
...
**Explanation:** Conformance claims and internal audits routinely disagree without either being wrong, and the reason is scope. A supplier tests a component in a demonstration harness with default settings; your teams compose several on a page, override styles, add validation and manage focus between them, and defects appear at the joins. Option B identifies this, converting an apparent contradiction into a specific and answerable question about what was tested. Options A, C and D are reasonable due diligence that does not touch the discrepancy, and asking them instead produces the appearance of scrutiny without its substance — which is worse than asking nothing, because it satisfies the room and closes the question. This is among the highest-value contributions available to you in a procurement discussion and one almost nobody else is positioned to make.
...
- **Measuring drop-off against those who continued.** It distorts the organisational ranking.
...
A verbal reasoning assessment measures how accurately you read. At your level the documents that matter are governance frameworks, organisational standards, audit reports, cross-government guidance, technical specifications, board papers, and contracts. A misread exception clause becomes an organisation-wide compliance failure; a misread audit finding becomes advice given confidently to a permanent secretary.
...
There is a direct professional payoff. Your role names collaborating with counterparts across government, and shared standards are the medium of that collaboration. Much of what blocks progress is a shared misreading — in both directions, since organisations over-comply with rules that do not reach them as often as they under-comply with rules that do.
...
- **Handling qualified language** maps to **Designing strategically**, where you work with leaders to ensure design is included early enough in policy, technology and delivery processes.
...
**Explanation:** The passage attaches an exception: organisations where all design work was delivered under a centrally managed programme are exempt. The statement's "every" contradicts that, so False. This is the most reliable pattern in the section. Note that the exception says "all design work", not "most", which narrows it considerably and supplies Question 3.
...
**Explanation:** The passage requires notification within ten working days of *identifying* the service, not of its release. Those triggers can be months apart — a service released in February and identified in a September assurance review must be notified in September, and would not be retrospectively late. The statement misstates the trigger, so False. Small distinction, large consequence: trigger events determine compliance, and misreading one produces either unnecessary alarm or false comfort, both expensive when reported to a cross-government board on your signature.
...
- **Reading fewer defects reaching live as better components.**
- **Confusing a rule about outcomes with a rule about conduct.**
- **Responding to implied stance.** Audit reports imply far more than they assert.
...
The second is that your authority is largely informal. Options leading with instruction, mandate or escalation score poorly — not because escalation is wrong, but because it is capital you spend rather than a tool you use freely.
...
- **Conditions and culture** map to **Leading design**, where you support a culture of learning and experimentation and iterate design maturity, and to your focus on the right conditions for designers.
- **Influence with senior leaders** maps to **Design communication** and to **Designing strategically**, where you work with leaders to include design early enough to inform decisions.
- **Cross-government collaboration** maps to collaborating with counterparts and to **Designing together**, where you help teams connect across boundaries.
- **Organisational inclusion** maps to **Designing for everyone**, where you guide organisations to adopt inclusive practices.
- **Embedding evidence practice** maps to **Evidence-based design**, where you guide the organisation in using evidence to improve services.

### Practice questions

**Question 1 (easy) — A designer under pressure from a director**

A lead designer tells you a director has asked them to remove an accessibility finding from a board summary because it "muddies the message". What is the most effective response?
...
**Explanation:** A standard everybody ignores has already failed, and reissuing changes only the date. Option B treats the objection as data — some requirements probably are unworkable and the rest usually unclear. Revising with designers produces authorship and therefore defenders, the only mechanism by which a standard becomes self-sustaining rather than dependent on your attention. The specific routine named is the right one for this discipline: a check before merge catches defects when they cost minutes rather than months, and turns compliance into a habit rather than an audit. Option A is least effective, the purest form of appearing to act. Option C enforces a standard people have told you is unrealistic, producing compliance theatre and resentment. Option D is useful and insufficient alone.
...
**Explanation:** Three departures in eight months alongside no critique and no professional contact is a structural pattern, and your role explicitly focuses on ensuring the right conditions and environment for designers. Option B addresses the structure on three fronts, and the deployment clause matters particularly for this discipline: interaction designers embedded singly make component and pattern decisions in isolation, those decisions diverge, and nobody notices for a year — so single embedding damages the work as well as the people. The negotiation detail matters too: protected time not paid for in delivery's currency gets cancelled by the third sprint, and you will have spent credibility introducing it. Option D is least effective, reproducing the attrition on a lag in a small recruitment market where your reputation travels. Option A addresses symptoms individually. Option C treats a design-of-work problem as a morale problem.

**Question 4 (moderate) — Assuring across a boundary**

A directorate you do not manage has shipped a custom component whose focus behaviour traps keyboard users. It is now in four services. What is most effective?
...
**Explanation:** The defect needs fixing and the relationship needs to survive, since you will be assuring this directorate for years. Option B goes to the people responsible first — they may hold context you lack, and the fix lands better from them — with a reproduction, because a vague report gets triaged low while a precise one gets fixed. The clause about communicating to the four services is most often omitted, without which a fixed component sits alongside four services running the broken version. Option A bypasses the person who can fix the component itself. Option C is disproportionate as a first move and converts assurance into confrontation. Option D is least effective by a distance: an annual return is a record, not an intervention, and keyboard users cannot use four services today.
...
**Explanation:** A prioritisation problem is being conducted as a political one, and the way through is to make the trade-off explicit and simultaneously visible. Option B does the analytical work and handles the politics correctly: putting the recommendation to both at once prevents the parallel-negotiation dynamic in which each director hears something slightly different and trust collapses when they compare notes, usually at the worst moment. Making a recommendation rather than presenting neutral options is essential; you are the expert on what design can deliver, and abdicating that wastes the role and the seat. Option A is least effective: splitting constrained capacity between two substantial needs produces two efforts too thin to inform either decision, and satisfies nobody. Option C ranks by visibility. Option D discards your judgement.

**Question 7 (moderate) — A technology decision already made**

A technology directorate has adopted a component library whose date picker, modal and custom select fail your standard. Five services already use it. What is strongest?
...
**Explanation:** A library is almost never uniformly good or bad — the complex interactive components fail while the buttons and inputs are fine. Option B establishes which, converting an unwinnable argument about a decision already made into a tractable list. That reframe matters practically and politically: five services cannot start again, so an answer requiring them to is an answer they will refuse, and you will have spent your standing for nothing. Option D is least effective because documenting a risk with nothing following it is how an exclusion becomes permanent while everyone feels they have handled it — and at your level your name is on that register entry. Option A asks for reversal without a route. Option C escalates a solvable disagreement across a boundary you need repeatedly.

**Question 8 (harder) — Inclusion practice that is not improving**

Your role requires guiding the organisation to adopt inclusive practices. After a year of guidance, templates and talks, components still routinely ship with keyboard defects. What is the strongest response?
...
**Explanation:** Three departments building one complex component three ways, none confident about assistive technology, is precisely the waste cross-government collaboration exists to prevent — and the accessibility argument is the strongest available, because properly testing a complex control is expensive and doing it once is the only realistic route to doing it well. Option B is calibrated to the authority you have: convening is available, mandating is not, and establishing whether the requirement is genuinely common avoids the familiar failure in which a shared component is agreed and then fits nobody. Option A is least effective, accepting solvable waste and leaving three inadequately tested components in public services. Option C reaches for a mandate before building the case; boards asked without evidence decline, spending the ask and making the second attempt harder. Option D creates nothing.

**Question 11 (harder) — Assurance failure you approved**

Nine months ago you approved a pattern now used in seven services. You realise its error handling assumes errors appear on the same page as the field, which breaks in the two services using it across multiple pages. What should you do?
...
**Explanation:** A pattern in seven services means a flaw is potentially seven defects, and the scoping matters as much as the disclosure — five services are fine, and telling them otherwise creates unnecessary work and erodes confidence in the pattern generally, which is a cost you pay for years. Option B does all four necessary things: notifies, scopes precisely, fixes both immediately and durably, and — the element specific to your level — asks why the approval did not test against a multi-page case, which is the question that prevents the next one. Option C is least effective: amending documentation without telling the two affected services leaves live defects while creating a record suggesting they were addressed, which is worse than silence because it will later be cited as evidence the issue was handled. Option A defers a live problem. Option D is disproportionate when a workaround exists.
...
**Explanation:** The anticipated objection is not obstruction; it is true, and a standard ignoring it will be resisted and technically unreasonable at once — the worst combination, because the resistance is justified and everyone will know it. Option B resolves the tension by changing what is required: documenting what was and was not tested is feasible for any team, and it is arguably more useful than a claim of full conformance, because it tells the next team exactly where the risk sits. The paired testing capability is the other half, because requiring coverage without enabling it produces either non-compliance or a tick-box claim, and you will get whichever is easier to fake. Option A is least effective: introducing a requirement you know to be contestable and arguing it case by case spends enormous credibility for a worse outcome. Option C removes the force. Option D exempts single-service components, exactly where undocumented limitations are most likely and most invisible.
...
- **Require honest documentation rather than unattainable coverage.**
...
Look back at the ground. In the cognitive section you audited a component entry as written rather than as you would have written it, named what three favourable test conditions had removed, weighted a pattern decision by the eight services that would reuse it, diagnosed eight teams' custom-component habit as one systemic cause with eight rationalisations, resolved an apparent contradiction between two date-control studies by asking what task each participant was performing, read a concentration of accessibility failures as a process diagnosis, and treated two unusually strong teams as a source of transferable routine rather than a story about pedigree. In the numeric section you weighted rather than averaged, distinguished a conformance claim's scope from an audit's, recognised a session metric masquerading as a journey measure, reconstructed an implied unit value, and declined to endorse a comparison that could not detect what it was built to find. In the verbal section you carried "all" across five lines, checked what started a deadline clock, noticed a conditional prohibition read as absolute, separated fewer defects reaching live from better components, and caught yourself responding to structural lean. And in the situational judgement section you absorbed a director's pressure, put an accessibility check where code review already happens, convened three departments you could not compel, campaigned for an owner for cross-service consistency, and designed a documentation standard around its strongest and truest objection.

Two threads run through all of it. The first is whether you know the limits of the evidence and will say so — in rooms where saying so is unwelcome, about findings that support conclusions you would prefer, and about your own approvals. The second is whether you act on mechanisms and conditions rather than instances. Between them those are most of what your role consists of. Organisations can generate opinions without you and read dashboards without you. What you supply is design reasoning that holds when someone pulls at it, conditions in which good design is the normal result, and a profession that will still be producing both after you leave.
