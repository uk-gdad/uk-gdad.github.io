...
Welcome! This guide has been created especially for you as a business architect working within the UK Government Digital and Data profession. Whether you are preparing for an internal assessment, applying for a new post, benchmarking your own capability, or simply curious about how psychometric assessments relate to your day-to-day work, this document will help you practise, reflect, and build confidence.

Psychometric assessments are structured, standardised exercises that measure the mental capabilities and behavioural tendencies that predict success in a role. For a business architect, that means far more than abstract puzzles. The assessments described here are job-specific: they use the kinds of artefacts you genuinely handle — capability maps, target operating models, strategy documents, benefits cases, stakeholder communications, and roadmaps — and the kinds of decisions you genuinely make, such as aligning programme design work with organisational strategy, mediating between senior stakeholders, and turning complex, fragmented information into clear multidimensional views that support executive decision making.

Why do these assessments matter for your role in particular? As a business architect, you sit at the intersection of strategy and delivery. You aggregate and disaggregate complex information from across your organisation, you communicate that information to stakeholders at every level, and you guide other architects in using the right tools and methods. Assessments of cognitive ability, numerical reasoning, verbal reasoning, and situational judgement map directly onto those demands. Practising them sharpens exactly the skills your role depends on: spotting logical inconsistencies in an operating model, interpreting a benefits realisation table under time pressure, extracting precise meaning from a dense policy document, and choosing the most effective course of action when stakeholders disagree.

This document is organised into four main assessment sections, each following the same pattern: an overview of what the assessment measures and why it matters for your role, a mapping of the assessment dimensions to the specific skills in the business architect capability framework, a substantial set of practice questions with full worked explanations, practical preparation tips, and common pitfalls to avoid.

Here is how to get the most from it. First, read each "About this assessment" section so you understand the format. Second, attempt the practice questions honestly — write down your answer before reading the explanation. Third, treat every explanation as a mini-lesson: even when you answer correctly, the reasoning walkthrough will deepen your technique. Finally, use the preparation tips for self-reflection: they connect assessment performance back to your professional development as an architect who supports executive-level work and guides others.
...
A workplace job-specific cognitive ability assessment measures the exact mental processes your role demands, using practical workplace scenarios rather than abstract puzzles. Unlike a generic intelligence test, it presents you with the everyday materials of your job — in your case, capability models, process hierarchies, strategy-to-delivery traceability matrices, governance papers, and architecture artefacts — and asks you to reason quickly and accurately about them.
...
For a business architect, cognitive ability assessment is particularly relevant because your core professional value is structured thinking. You develop an integrated view of an enterprise, and that requires holding many moving parts in mind at once: which capabilities support which strategic outcomes, which programmes affect which business areas, where design decisions contradict agreed principles, and what follows logically when one element of the operating model changes. A well-designed cognitive assessment simulates precisely those demands in miniature.

### What it measures for your role

The assessment dimensions map directly to the skills in your capability framework:

- **Pattern recognition** maps to your **Business architecture** skill: producing clear multidimensional views of your organisation means recognising recurring structures — duplicated capabilities, common process patterns, repeated dependencies — across large and messy information sets.
- **Logical deduction** maps to **Strategic thinking** and **Strategic design and business change**: defining strategies and evaluating whether current strategies meet business requirements requires you to reason validly from principles, patterns, standards, policies, and roadmaps to their consequences.
- **Error checking** maps to **Methods and tools** and **Business architecture**: when you build capability in methods and tools and ensure they are adopted consistently, you must spot inconsistencies between artefacts — a capability map that contradicts a value stream, a roadmap milestone that conflicts with a policy constraint.
...
- **Problem solving** maps to **Consultancy** and your duty to aggregate and disaggregate complex information from across your organisation: stakeholders bring you tangled business challenges, and you must decompose them, model them, and recommend next steps.

### Practice questions

**Question 1 (easy) — Pattern recognition in a capability model**

Your organisation's business capability model uses a three-level hierarchy. Level 1 capabilities are named with one word (e.g. "Casework"). Level 2 capabilities are named "Level-1 name + colon + function" (e.g. "Casework: Triage"). Level 3 capabilities append a further colon and activity (e.g. "Casework: Triage: Identity verification"). While reviewing a draft model produced by a junior architect, you see these entries:
...
**Explanation:** The pattern requires the Level 1 capability name to come first, with each colon adding a deeper level. Entry 4 inverts the hierarchy: "Reconciliation" is a Level 2 function under "Payments", so a Level 3 entry must read "Payments: Reconciliation: Bulk matching". Entries 2, 3 and 5 all follow the rule. This is exactly the kind of consistency check you perform when guiding others in using architectural tools and methods: naming conventions look trivial, but broken conventions destroy the traceability that makes a model usable for decision making.

**Question 2 (easy) — Logical deduction from design principles**

Your architecture principles state: "Every citizen-facing service must reuse the departmental identity capability unless a formal exemption is granted by the design authority." A programme team tells you: "Our new benefits application service is citizen-facing and does not use the departmental identity capability." Which one of the following conclusions must be true?
...
**Explanation:** The principle is a conditional rule with one permitted exception. From the facts given, you cannot tell whether an exemption exists, so neither A nor B must be true on its own — each is merely possible. D introduces information not present at all. The only conclusion that must hold in every case consistent with the facts is the disjunction in C. Assessments reward this discipline: deduce only what the given information guarantees. In your role, the same discipline stops you accusing a programme of non-compliance before checking the exemptions register — which protects your stakeholder relationships as well as your logic.

**Question 3 (moderate) — Error checking a traceability matrix**

You maintain a matrix tracing strategic objectives to the capabilities that deliver them. An extract reads:
...
**Explanation:** Check each rule. Rule (i): SO1 appears twice (rows 1 and 4) with two different capabilities — but wait, read carefully: rule (i) says each objective is supported by exactly one capability, and SO1 is shown supported by both "Automated triage" and "Master data management", so at least one of rows 1 and 4 is wrong; however, the question asks how many rows are inconsistent with the document, and row 4 violates rule (ii) as well, because it assigns master data management work to Programme Alpha rather than Programme Beta. Row 4 therefore breaches both rules, while rows 1, 2 and 3 each breach neither on their own — row 1 is only rendered problematic by row 4's existence, and removing row 4 restores full consistency. The single defective row is row 4, so the answer is 1. This mirrors real artefact review: locate the minimal correction that restores consistency rather than flagging every symptom as a separate defect.

**Question 4 (moderate) — Prioritisation under governance pressure**

It is Monday morning. Four items compete for your attention:

1. The design authority meets Wednesday and needs your review of a programme's target operating model, without which the programme cannot proceed to its funding gate.
...
3. A director has emailed asking for "a quick view" of how a proposed machinery-of-government change would affect your business area — no deadline stated.
4. Your quarterly update of the enterprise capability model is due at month end, two weeks away.
...
**Explanation:** Prioritisation questions test reasoning about impact and urgency together. Item 1 is both urgent (Wednesday) and high impact (it blocks a funding decision affecting delivery of strategy). Item 3 has no stated deadline but concerns a machinery-of-government change — strategically significant and sponsored by a director, so it comes next; a brief scoping reply also lets you manage the director's expectations early. Item 2 matters (guiding others is part of your role level) but has a Friday deadline and can follow. Item 4 is important, routine, and two weeks away. Option A over-weights seniority against a hard governance deadline; C treats the undated director request as lowest priority purely because it lacks a date, which confuses "no deadline" with "no urgency"; D inverts impact ordering. Note the pattern: the strongest answer sequences by impact-weighted urgency, not by any single dimension.

**Question 5 (moderate) — Pattern recognition across operating model documents**

You are consolidating operating model summaries from four business units. Each summary lists functions in a fixed order: Customer contact, Casework, Decision making, Payments, Assurance. You notice the following counts of full-time-equivalent staff (FTE) recorded for "Assurance" as a percentage of each unit's total: Unit A 5%, Unit B 6%, Unit C 19%, Unit D 5%. The four units perform comparable work at comparable volumes. As a business architect, what is the most reasonable first interpretation of Unit C's figure?
...
**Explanation:** Work forwards through the dependencies. Cleansing finishes end of Q2, so migration can occupy Q3 at the earliest and completes at the end of Q3. Case management go-live therefore cannot occur before Q4. Training must fall in the go-live quarter (Q4) or the quarter immediately before it (Q3). The earliest permissible quarter for training is therefore Q3. A tempting error is to place training in Q4 by anchoring on go-live; another is Q2 by forgetting migration takes a full quarter. Dependency reasoning of exactly this kind underpins your duty to ensure business change is implemented effectively to meet strategy — a roadmap that trains staff too early wastes the training; too late, it delays benefits.

**Question 7 (moderate) — Error checking a benefits map**

A benefits map submitted to you claims: "Enabler: single sign-on → Intermediate benefit: fewer password reset calls → End benefit: reduced contact centre cost → Strategic objective: improved citizen satisfaction." Which link in the chain is logically weakest as drawn?
...
**Explanation:** Treat the three statements as premises and test joint consistency. Premise (iii) makes the programme director accountable for the target operating model (sign-off implies accountability). Premise (ii) makes the business architect accountable for the same artefact. Premise (i) permits exactly one accountable role per deliverable. All three cannot be true together — that is the flaw, and it is a joint inconsistency rather than a defect in any single premise taken alone. Options C and D attack individual premises with outside opinions rather than logic; option A denies premise (iii) rather than working within the given rules. In practice you resolve this by clarifying that the architect is Responsible while the director is Accountable — a conversation you will have often when supporting executive-level work.

**Question 10 (challenging) — Aggregation and disaggregation logic**

You aggregate incident data from three service lines into a single organisational view. Service line X reports incidents per 1,000 transactions; service line Y reports incidents per week; service line Z reports incidents per 1,000 transactions but counts only incidents lasting over one hour. Which single statement best describes what you can validly conclude from a naive sum of the three reported figures?
...
**Explanation:** X and Z share a per-transaction denominator but different incident definitions (Z undercounts by excluding short incidents — note that B claims the opposite direction of bias). Y uses a time denominator, which cannot be added to per-transaction rates at all. No adjustment mentioned in D repairs a definitional mismatch. The only valid conclusion is C: before aggregating, you must normalise both the denominator and the definition. This is the heart of your role-level duty to develop standard and scalable models to collect, aggregate, or disaggregate complex information — the model must enforce common definitions before any roll-up is meaningful.

**Question 11 (challenging) — Prioritising architectural debt**

Your capability assessment scores four capabilities on strategic importance (1-5) and current maturity (1-5):
...
Using a standard "invest where importance is high and maturity is low" heuristic, which capability should you recommend as the top investment priority, and which as the clearest candidate for maintain-only?
...
**Explanation:** Good decomposition is mutually exclusive and collectively exhaustive relative to the mechanism that produces the outcome. Productivity in a casework operation is a function of what arrives (demand), what capacity and capability exist to process it, and how efficiently work flows between steps — option B covers the whole causal system and defers conclusions until evidence is examined. Option A slices by an attribute that may correlate with the problem but cannot explain it end to end. Option C imposes a false binary that fragments interdependent causes, and commissioning parallel reviews before framing the problem invites contradictory findings. Option D reaches for a solution before understanding the problem — the opposite of your Strategic design and business change skill's instruction to focus on outcomes rather than solutions. In assessments and in consultancy alike, the candidate who structures the problem before answering it consistently outperforms the one who jumps to a familiar remedy.

### Preparation tips

- **Practise with your own artefacts.** Take a real capability model, roadmap, or RACI from your work and actively hunt for inconsistencies. Ten minutes a day of deliberate error-checking builds the same muscle the assessment measures.
- **Verbalise your deductions.** When you conclude something from a set of rules, say the inference chain aloud or write it down. Assessments penalise plausible-sounding leaps; your consultancy work does too.
- **Time-box ruthlessly in practice.** Work at roughly one minute per question. If a question resists you for 90 seconds, flag it and move on — accuracy on ten questions beats perfection on four.
- **Use elimination.** On multiple-choice items, discard options that introduce facts not given in the stem. In this practice set, most wrong answers smuggled in outside information — real assessments do the same.
- **Rest and pace yourself.** As an experienced professional you may feel assessments are beneath you; approach them instead as a professional performance, with sleep, hydration, and a distraction-free environment, exactly as you would prepare to present to a board.

### Common pitfalls

- **Bringing outside knowledge into closed-world questions.** Cognitive items define a miniature world of rules. Your deep organisational knowledge is an asset at work but a liability here if it overrides the stated premises.
- **Confusing "consistent with" and "implied by".** Many candidates select an answer that could be true rather than the one that must be true. Train yourself to ask: does the given information guarantee this?
- **Time sink questions.** Getting stuck on a single multi-constraint puzzle and sacrificing five easier questions is the most common score-killer. Skip and return.
- **Misreading hierarchies and labels.** As with the capability naming question above, assessments hide errors in structure rather than content. Read table headers, level indicators, and qualifiers with the same care you give a governance paper.
- **Overconfidence at senior level.** Experienced architects sometimes pattern-match to a familiar real-world situation and answer from memory rather than from the stem. The test rewards fresh reasoning every time.

## Workplace job-specific numeric reasoning assessment

### About this assessment

A workplace job-specific numerical reasoning assessment evaluates your ability to analyse, interpret, and make sound decisions using numerical data drawn from the real demands of your role. It is emphatically not a mathematics exam: the arithmetic rarely goes beyond percentages, ratios, weighted averages, and rates of change. What it tests is whether you can extract the right numbers from realistic business material — budget tables, capacity plans, benefits registers, survey results, performance dashboards — and reason with them quickly and correctly.

Typical format: an online, strictly timed test, often 20 to 30 minutes for 15 to 25 questions, with an onscreen calculator allowed or provided. The priority is interpretation over mental arithmetic: the hard part is choosing what to calculate, reading scale qualifiers such as "in thousands" or "FTE", and avoiding traps like mixing monthly and annual figures. Question inputs mimic the data formats of the target role, so for you they will look like the spreadsheets and dashboards that cross a business architect's desk every week.

Numerical fluency matters more to your role than the job title might suggest. You develop standard and scalable models to collect, aggregate, or disaggregate complex information — and most of that information is quantitative: headcount by function, cost by capability, benefit by programme, demand by channel. When you support executive-level work, you are often the person who must notice that a business case's numbers do not add up, that a capacity plan assumes an impossible productivity gain, or that two directorates are reporting the same saving twice. Executives will make real decisions on the figures you present, so your numerical reasoning is a matter of professional credibility.

### What it measures for your role

- **Interpreting cost and budget tables** maps to your **Business architecture** skill: multidimensional views of the organisation routinely combine money, headcount, and volume, and decision makers rely on you to keep the dimensions honest.
...
- **Benefit aggregation and double counting checks** map to **Making and guiding decisions**: recommending decisions as risk and complexity increase requires you to verify that the numbers underpinning a recommendation are internally consistent.
...
Your directorate's transformation budget is £8.4 million. The business architecture practice is allocated 3.5% of it. How much is the practice's allocation?
...
**Explanation:** 3.5% of £8,400,000 = 0.035 × 8,400,000 = £294,000. A quick sanity check: 1% is £84,000, so 3.5% is 3.5 × £84,000 = £294,000. Option C is 4% and option A is roughly 2.9% — both catch candidates who misplace the decimal or estimate carelessly. Even at this easy level, the habit of checking with a second method (1% scaling) is worth building.
...
**Explanation:** 480 ÷ 60 = 8, so the ratio is 8:1. Ratios appear constantly in operating model design — spans of control, support-to-frontline ratios, licence-per-user counts — and assessments like them because a single division answers the question if you pick the right two numbers. The distractors correspond to dividing by the wrong support figure, so always confirm which two populations the question compares.
...
**Explanation:** Increase = 51,000 − 42,500 = 8,500. Percentage increase = 8,500 ÷ 42,500 = 0.20 = 20%. The classic error is dividing by the new figure: 8,500 ÷ 51,000 ≈ 16.7%, which rounds to option B — a distractor placed deliberately. Percentage change always uses the original (earlier) value as the denominator. When you evaluate strategy against uptake targets, this distinction changes whether a channel-shift target is reported as met or missed.

**Question 4 (moderate) — Weighted average maturity score**

Your capability assessment covers three business areas. Area 1 has 12 capabilities with an average maturity of 2.5; Area 2 has 8 capabilities averaging 3.0; Area 3 has 20 capabilities averaging 2.0. What is the organisation-wide average maturity per capability?
...
**Explanation:** Weight each average by its capability count: (12 × 2.5) + (8 × 3.0) + (20 × 2.0) = 30 + 24 + 40 = 94. Total capabilities = 12 + 8 + 20 = 40. Weighted average = 94 ÷ 40 = 2.35. Option B is the trap: the simple average of 2.5, 3.0 and 2.0 ignores that the areas contain different numbers of capabilities. When you aggregate assessment scores into an organisational view, unweighted averages silently distort the picture towards small business areas — exactly the kind of aggregation error your standard models must prevent.
...
**Explanation:** Annual cases per caseworker = 9 × 210 = 1,890. Required FTE = 1,050,000 ÷ 1,890 ≈ 555.6, which rounds up to 556 — you cannot employ a fraction of a person, and rounding down would leave demand unmet. Option A comes from using 10 cases per day; option B from using a 200-day year then rounding oddly. Two lessons: build the per-person annual rate first, and in capacity planning always round staffing up. When you review a programme's operating model, recomputing one headline figure like this is a fast, high-value assurance check.
...
**Explanation:** Q1 total = 1,240 + 830 + 460 = 2,530. Q2 total = 1,310 + 745 + 552 = 2,607. Change = 2,607 − 2,530 = 77 — but the table is in £ thousands, so the change is £77,000, an increase. Option C punishes ignoring the scale qualifier; option B punishes subtracting in the wrong direction. Assessments almost always include at least one "in thousands/millions" trap, and so do real finance packs — reading the units line is the first thing you should do with any table, in a test or in a board paper.

**Question 8 (challenging) — Double counting in aggregated benefits**

You aggregate benefits claims from three programmes: Programme A claims £1.2m per year from reduced contact volume; Programme B claims £0.9m per year, of which its business case notes "£0.4m arises from the same contact-volume reduction claimed by Programme A"; Programme C claims £0.6m per year, all independent. What is the correct total annual benefit for the portfolio view you present to the executive committee?
...
**Explanation:** A naive sum is 1.2 + 0.9 + 0.6 = £2.7m (option A). But £0.4m of Programme B's claim duplicates benefit already counted in Programme A's £1.2m, so it must be removed once: 2.7 − 0.4 = £2.3m. Option C wrongly removes the overlap twice (from both A and B); option D removes B's entire claim. Double counting is one of the most common defects in portfolio-level benefit statements, and detecting it is a signature contribution of the business architect who sees across programmes when each programme sees only itself. In your portfolio view, show the gross figures and the de-duplication adjustment explicitly so the executive committee can see the working.
...
**Explanation:** Telephone cost per contact = £6,000,000 ÷ 800,000 = £7.50. Digital cost per transaction = £1,800,000 ÷ 2,400,000 = £0.75. Each shifted contact saves £7.50 − £0.75 = £6.75. For 200,000 contacts: 200,000 × £6.75 = £1,350,000. Option A ignores the cost of handling the shifted volume digitally; option D subtracts the rates in a muddled way. Note also the assumption the stem grants you — fully variable costs — which real life rarely does: in a genuine business case you would challenge exactly that assumption, as telephone channels carry fixed costs that do not fall linearly with volume. Assessments give you the assumption; consultancy work makes you test it.

**Question 10 (challenging) — Stakeholder survey base sizes**

Your annual stakeholder survey results: of 120 senior stakeholders invited, 45% responded; of 400 operational stakeholders invited, 30% responded. Among senior respondents, 50% rated architecture engagement "good or better"; among operational respondents, 45% did. How many respondents in total rated engagement "good or better"?
...
**Explanation:** Work through each group separately, in counts rather than percentages. Senior respondents = 120 × 0.45 = 54; of these, 50% rated good or better = 54 × 0.50 = 27. Operational respondents = 400 × 0.30 = 120; of these, 45% rated good or better = 120 × 0.45 = 54. Total = 27 + 54 = 81. Option A counts only the operational group; option C adds the two respondent totals (54 + 120) without applying the rating percentages; option D applies the rating percentages to invited populations rather than respondents. The professional lesson is real: percentages of percentages are meaningless until converted back to counts, and base sizes change at every step. When you report survey findings to stakeholders, always show the underlying counts alongside the percentages — a "50% good or better" headline from 54 senior respondents carries very different evidential weight from the same percentage across the whole organisation.
...
**Explanation:** Year 2 = £2.4m × 1.25 = £3.0m. Year 3 = £3.0m × 0.60 = £1.8m. Total = 2.4 + 3.0 + 1.8 = £7.2m. The essential technique is that successive percentage changes multiply — Year 3 is 60% of Year 2, not "Year 1 minus 15%" or any additive shortcut. Option B comes from applying the 40% reduction to Year 1; option D from adding rather than compounding. Roadmap papers you review will phase costs exactly like this, and being able to recompute the profile in your head, in seconds, makes you a sharper reviewer in governance meetings.
...
**Explanation:** Current total cost = 18,000 + 26,400 + 9,600 = £54,000. Total licences = 30 + 40 + 12 = 82. Consolidated cost = 82 × £540 = £44,280. Saving = 54,000 − 44,280 = £9,720. Option C is the consolidated cost minus £30,000 (a misread of Team 1's figure); option D applies £540 to only 30 licences of savings. A useful professional observation: the three teams currently pay very different unit rates (£600, £660, and £800 per licence), and surfacing that spread is often more persuasive to stakeholders than the headline saving — it demonstrates concretely why consistent adoption of methods and tools, one of your named skills, has financial as well as quality benefits.
...
**Explanation:** The coverage measure is distinct units reached divided by total units: 11 ÷ 14 = 0.7857 ≈ 79%. The per-workshop attendance figures (9, 7, 8, 6, 10) are deliberate noise — summing them gives 40 attendances, which double counts units that attended several workshops and cannot exceed a meaningful percentage of anything. Option C (12 ÷ 14) and option A (10 ÷ 14) punish miscounting. The distinction between attendances and distinct attendees is the events version of double counting, and it matters when you report engagement coverage to your head of practice: "40 attendances" sounds impressive, while "3 of 14 business units still unengaged" is the number that actually drives your communications strategy.

### Preparation tips

- **Rebuild the denominator habit.** Before every calculation, say to yourself: "percentage of what?" The majority of numerical reasoning errors — in tests and in benefit reports — are denominator errors.
- **Practise with real government data formats.** Spend practice time with spending tables, workforce statistics, and performance dashboards of the kind published by UK government departments; the layouts, units, and scale qualifiers mirror what assessments use.
- **Use the calculator for arithmetic, your head for structure.** Decide the calculation steps before touching the calculator. Candidates who calculate first and think second run out of time.
- **Estimate before you compute.** A rough order-of-magnitude estimate ("about £1.3m") catches keystroke errors instantly and mirrors your professional habit of sense-checking figures in governance papers.
- **Round only at the end.** As Question 10 showed, rounding intermediate values compounds into wrong answers. Carry full precision through the chain.
- **At your level, watch for assumption traps.** Senior-calibrated questions often hide the real test in a stated assumption (fully variable costs, constant productivity). Answer the question as posed, and note professionally which assumptions you would challenge in real life.

### Common pitfalls

- **Misreading chart and table labels** — confusing monthly with annual data, or ignoring qualifiers like "in thousands" or "FTE". The Q7 trap above is the single most common failure mode in numerical assessments.
- **Over-calculating** — performing long exact computations when estimation or a scaling shortcut (1% of £8.4m is £84k) reveals the answer faster. Time pressure punishes elegance-free arithmetic.
- **Time sink questions** — wrestling one multi-stage problem while three quick wins go unanswered. Bank the easy marks first; return if time allows.
- **Adding percentages that compound** — successive changes multiply. "Plus 15% then plus 10%" is 26.5%, never 25%.
- **Using the wrong base for change** — percentage change divides by the original value; shortfall divides by the forecast. State the base to yourself before dividing.
- **Double counting on aggregation** — when combining figures from multiple sources, always ask whether any component is claimed twice, exactly as in portfolio benefit views.

## Workplace job-specific verbal reasoning assessment

### About this assessment

A workplace job-specific verbal reasoning assessment evaluates how well you understand, analyse, and draw correct conclusions from written business information. It mirrors the exact reading demands of your role: passages use relevant terminology from strategy papers, standards, policy documents, governance emails, and review reports, and you must answer based strictly on the text provided, setting aside anything you happen to know from outside it.

Typical format: a short passage (100-300 words) followed by statements you must classify as **True** (the passage guarantees it), **False** (the passage contradicts it), or **Cannot Say** (the passage provides insufficient information either way), plus some multiple-choice comprehension items asking for the best summary, the author's main point, or the precise scope of a rule. Timing is tight — often under a minute per question — deliberately simulating workplace deadlines.

For a business architect, verbal precision is not a nice-to-have; it is the substance of the job. You translate between the language of strategy and the language of delivery. You read vision statements, policies, and standards, and you must extract exactly what they commit the organisation to — no more and no less. When you communicate complex information about the organisation to stakeholders, a single overstated conclusion ("the strategy requires X" when it merely permits X) can misdirect a programme for months. And when you mediate between stakeholders, the ability to pin down precisely what a document does and does not say is often what dissolves the disagreement.

### What it measures for your role

- **Reading precision on rules and standards** maps to your **Business architecture** and **Strategic design and business change** skills: supporting the definition of principles, patterns, standards, policies, roadmaps and vision statements demands exact comprehension of normative language — must, should, may, unless.
- **Distinguishing fact from inference** maps to **Consultancy**: your advice carries authority, so you must separate what the evidence states from what you are adding by judgement, and label each honestly.
- **Summarising and identifying the main point** maps to **Communicating information**: representing complex positions to large audiences requires you to compress text without distorting it.
...
**Explanation:** The passage states this almost verbatim: "A TOM review does not constitute approval of the programme's business case, which remains the responsibility of the investment committee." When the text directly asserts the statement, the answer is True. Note the professional significance of that sentence: it protects your practice from scope creep, ensuring an architecture review is not misrepresented to a board as investment endorsement — a distinction you may need to restate often when supporting executive-level governance.
...
**Explanation:** The passage says TOMs are reviewed by "the business architecture practice", and separately that the head of business architecture gives written approval for light-touch summaries. It never states who within the practice conducts TOM reviews. The head might review all of them, some, or none — the text simply does not say. Choosing True here would import an organisational assumption from your own experience; choosing False would wrongly treat "the passage doesn't say so" as "the passage denies it". Cannot Say is the disciplined answer, and this discipline — refusing to let plausibility masquerade as evidence — is the single most tested skill in verbal reasoning.
...
**Explanation:** The resubmission rule states revised versions must be resubmitted "unless the changes are editorial only". Typographical corrections and a meaning-preserving heading reword are editorial, so the exception applies and resubmission is not required. Option A ignores the exception clause; option C invents a rule the passage never states. Option D is the subtle distractor: the resubmission sentence refers to "a programme" revising "its TOM", and you could argue a light-touch summary is not a TOM — but the passage treats the summary as the instrument produced "instead", within the same regime, and the strongest reading applies the same revision rule; assessments expect the best-supported answer, not the most contrarian one. In real standards work, you would note this drafting ambiguity and fix it — which is precisely the "define guidance" contribution your Consultancy skill describes.
...
**Explanation:** The email says only that "the minister has taken a personal interest in this programme's timeline". Interest in the timeline tells you nothing about the minister's view of the interim-solution proposal — the minister may not even know of it. The sentence is doing rhetorical work: it is placed to make refusal feel risky, inviting you to infer ministerial backing that is never claimed. Verbal reasoning assessments test whether you resist precisely this inference, and so does real governance: when you host or moderate discussions about high-risk decisions, separating documented positions from implied pressure protects both the decision and the relationships around it.
...
**Explanation:** Check each ambition against outturn: digital channel share 83% against an 80% ambition — exceeded; cost per transaction fell 19% against a 25% ambition — missed; user satisfaction 86% average against an 85% ambition — met. Two of three were met or exceeded, so the statement is True. The arithmetic is trivial; the skill is systematic checking. In evaluation work you will often find that headline conclusions ("substantially achieved") summarise a mixed scorecard, and your value lies in being able to reproduce the detail behind the summary on demand.
...
**Explanation:** The passage states that satisfaction "averaged 86% across services, although two high-volume services recorded satisfaction below 75%". The statement is directly contradicted: at least two services fell below 85% (indeed below 75%). This is the average-versus-distribution trap in verbal form — the same trap Question 13 of the numeric section showed in numbers. The evaluation itself draws the professional conclusion for you: set targets at service level rather than as a single average, because averages let poor experiences for many users hide behind good experiences elsewhere. Championing that kind of measurement honesty is part of sharing the value of business architecture with the organisation.
...
**Explanation:** The passage states plainly that "no decision has yet been taken on the future of the fraud investigation team". The team's destination is undetermined by the text: it might transfer, stay, or split. Answering False would claim the passage rules out a transfer, which it does not; answering True would treat one possible outcome as settled. Cannot Say is the only verdict the text supports. Note the professional resonance: a team that "supports both licensing and non-licensing casework" is a shared capability straddling the new organisational boundary — precisely the kind of unresolved dependency you would flag in a target operating model as a decision the executive must make before cutover, with options and impacts set out for each.

### Preparation tips

- **Answer from the passage, never from your experience.** You know how TOM standards usually work; the test asks only what this passage says. Practise consciously suspending your expertise — a genuinely difficult skill for experienced professionals.
- **Locate the qualifying clause.** Professional-level passages state a rule and qualify it later ("unless", "except", "subject to"). Before answering any rule question, scan for the qualifier.
- **Calibrate the three verdicts.** True = the passage guarantees it. False = the passage contradicts it. Cannot Say = neither. If you find yourself reasoning "well, it's probably true in practice", you have drifted into Cannot Say territory.
- **Watch modal verbs and hedges.** Must, should, may, propose, intend, subject to — underline them mentally. They carry the passage's real commitments.
- **Practise on real documents.** Government service standards, spend control policies, and published strategy evaluations offer ideal practice material with exactly the register assessments imitate.
- **Manage reading time.** Skim the passage once for structure, then read the statement, then return to the relevant sentences for verification. Reading the passage exhaustively before seeing any question wastes your tightest resource.

### Common pitfalls

- **Making assumptions** — importing personal or organisational knowledge instead of relying only on the text. The Cannot Say option exists precisely to catch this.
- **Misinterpreting nuance** — treating "constrained by" as "caused by", a proposal as an agreement, or a likely outcome as a stated fact. Intensity upgrades are the assessment writer's favourite trap.
- **Stopping at the first relevant sentence** — early general rules are qualified by later exceptions; the answer usually lives in the interaction between two sentences.
- **Poor time management** — spending too long absorbing the whole text instead of scanning for the keywords the statement raises.
- **Contrarian overthinking** — at senior level, some candidates argue themselves out of the best-supported answer by constructing exotic readings. Choose the answer the passage best supports, and save the drafting critique for your day job.
...
Typical format: short scenarios (100-200 words) describing a workplace conflict, ethical tension, or operational challenge, followed by three to five possible responses. You are asked either to select the **most effective** and **least effective** actions, or to rank or rate all the options. Timing is usually generous or untimed, because the assessment targets natural judgement rather than speed.

For a business architect, situational judgement is arguably the most role-relevant assessment of the four. Your framework skills are dominated by human dynamics: mediating between people and mending relationships, managing stakeholder expectations in high-risk discussions under constrained timescales, building consensus between services or independent stakeholders, guiding other architects, and advising executives. The technically correct architecture answer delivered without judgement about people, timing, and trust routinely fails; the assessment simulates exactly those moments where what you do next matters more than what you know.

### What it measures for your role

- **Mediation and relationship repair** maps directly to **Communicating information**: "mediate between people and mend relationships, communicating with stakeholders at all levels" is a literal line in your skill description, and several scenarios below test it.
...
- **Consensus building and escalation judgement** maps to **Making and guiding decisions**: making medium-risk decisions yourself, recommending rather than deciding as risk and complexity increase, and knowing which is which.
- **Guiding and developing others** maps to your role-level duty to support and guide other business architects and to build capability in **Methods and tools**.
...
You discover that a major programme has taken its future-state operating model to its funding gate without the required business architecture review, and the gate approved it. The design contains a capability duplication your practice would have challenged. The programme director is influential and known to regard architecture governance as bureaucracy.
...
- Option C: Soften the scores as asked — the sponsor owns the board relationship and understands the audience better than you do.
...
- Option D: Tell the product manager that criticism of your practice's staff should come through you in future, and defend the junior's work.

**Most effective: C. Least effective: B.**

**Explanation:** Option C develops the junior (your role level explicitly includes guiding other business architects), repairs the stakeholder relationship quickly, and protects tomorrow's outcome — with a sensible fallback if quality cannot be reached in time. Option B is the least effective despite feeling helpful: it humiliates the junior by silent replacement, teaches them nothing, signals to the product manager that your practice's quality depends on one person, and is unsustainable as a leadership pattern. Option A prizes transparency but ambushes the junior with raw criticism in front of a stakeholder — feedback should reach them from their guide, framed for learning. Option D treats legitimate quality feedback as a protocol violation; defending flawed work costs your practice more credibility than the flaws themselves. Guiding others means letting them carry the work while you carry the safety net.

**Question 5 (challenging) — Constrained timescale, high-risk discussion**

A ministerial commitment requires a decision within five working days on which of two business units will operate a new service. The units' leaders disagree strongly, each has produced their own analysis, and the programme has asked you to moderate a decision workshop in two days. You privately believe one option is clearly better, but your analysis is one input among several.

- Option A: Circulate your own analysis beforehand marked "recommended option", so the workshop starts from the right answer.
- Option B: Design the workshop around agreed decision criteria: circulate both units' analyses plus your own in advance, open by agreeing the criteria (user needs, cost, risk, time to implement), assess each option against the criteria together, and record the decision and dissent transparently for the accountable executive.
...
**Explanation:** Option B is textbook moderation of a high-risk, high-complexity discussion within a constrained timescale — a literal phrase from your Communicating information skill. Agreeing criteria before assessing options is the classic mechanism for converting positional conflict into joint problem-solving, and transparent recording of dissent respects both losers and the accountable executive. It also correctly positions you as recommending rather than deciding, matching your decision-making skill's escalation gradient. Option A is least effective: pre-anointing your own answer destroys your neutrality as moderator, invites both units to attack the process rather than engage with criteria, and converts a decision workshop into a ratification exercise that will not hold. Option C may occasionally be right, but a statutory-style ministerial deadline was given as fixed; recommending delay without attempting a structured decision reads as avoidance. Option D can work for minor disputes, but here it manufactures consent behind closed doors for a decision that needs open legitimacy — and if either leader balks at the "announcement", you have spent your credibility on a deal that failed.
...
**Explanation:** Option C threads the needle: it protects the source completely, gives the director a dignified, legitimate route to surface a genuine intention, reinforces that the model has a change process (structure changes are not forbidden — unmanaged ones are), and positions you as steward rather than enforcer. If the director discloses, you channel the change properly; if they deny it, you have documented the dependencies and the process anyway. Option B is least effective: it burns the source (the director will hunt for who talked), converts a manageable governance conversation into an accusation, and rests your credibility on an unverified rumour. Option A mistakes confidentiality for inaction — you owe the source anonymity, not paralysis; the dependencies at risk are your professional responsibility. Option D escalates hearsay into formal record without verification, harming both the director (if false) and the source (if traced), and skipping the direct professional relationship that could resolve it quietly.

**Question 11 (moderate) — Ranking: the impossible week**

Your head of practice is seconded elsewhere for a month, leaving you to support executive-level work in their place. In the same week: (1) the executive committee requests a one-page view of transformation dependencies for Thursday; (2) a programme demands sign-off of their operating model by Wednesday "or we miss our gate"; (3) a fellow architect asks you to co-review their first executive paper, presentable any time this month; (4) an external government community has asked you to speak on business architecture next month and needs a title by Friday. Rank the four demands in the order you would address them.
...
**Explanation:** Demand 2 comes first: it has the earliest hard deadline (Wednesday) and a gate miss carries real delivery cost — though note a strong candidate would also test whether "sign-off" can be scoped, since rubber-stamping under pressure is its own risk. Demand 1 is second: Thursday deadline, highest-ranking audience, and exactly the executive support your role level describes. Demand 4's Friday deadline is trivial in effort (a title) but real — a two-minute task with a fixed date beats an undated task, so it slots third; sequencing by deadline does not mean sequencing by effort. Demand 3 is genuinely important (guiding others) but explicitly flexible ("any time this month"), so it comes last this week and gets protected time later — deprioritising is not dropping. Option A forgets that demand 4 has this week's deadline while demand 3 does not; option B and D under-rank the gate-blocking sign-off. Rankings test whether you can hold urgency, impact, effort, and audience in one judgement — the everyday arithmetic of a practice leader's week.

**Question 12 (challenging) — The accessibility corner-cut**

A programme under severe deadline pressure proposes descoping the assisted digital support journey from its first release: "it affects under 4% of users, and we will add it in release two, three months later". The service's users include a higher-than-average proportion of older people and people with disabilities. The programme asks you, as the reviewing architect, to endorse the descope as "aligned with the phased roadmap".
...
- Option C: Endorse it, but attach a written note that you have concerns about accessibility.
- Option D: Refuse and report the programme to the accessibility compliance team.

**Most effective: B. Least effective: A.**

**Explanation:** The percentage framing is the trap: 4% of users is not 4% of the service for the people concerned — it is 100% of their access, and they are disproportionately the users public services exist to reach. Option B refuses cleanly but constructively: it names the real decision (executive risk acceptance of a legal and values-based obligation, which is above an architect's sign-off — matching your escalation gradient of recommending as risk increases), and it helps the programme solve its underlying schedule problem, which is legitimate. Option A is least effective because it launders a values-and-compliance breach through architectural vocabulary — "phased roadmap" — lending your professional authority to exactly the corner-cut governance relies on you to catch. Option C is A with a paper trail: endorsement is the operative act, and a filed concern protects you, not the users. Option D leaps to enforcement before dialogue, forfeiting the chance to fix the problem collaboratively and casting your practice as police — sometimes necessary eventually, never optimal first.

### Preparation tips

- **Anchor on values, then on role.** For each scenario ask first: what do user needs, transparency, collaboration, accessibility, and inclusion point to here? Then ask: what does my role level make mine to decide versus mine to recommend? Most strong answers sit at the intersection.
- **Look for the option that fixes the problem and the system.** The best responses usually address the immediate issue, the underlying cause, and the relationship — options that achieve only one of the three are rarely "most effective".
- **Beware satisfying answers.** Options that punish wrongdoers, prove you right, or display toughness feel good and score badly. Effectiveness is measured in outcomes, not catharsis.
- **Practise articulating your reasoning aloud.** For each practice scenario, explain to yourself why each option is stronger or weaker. Interview panels increasingly ask you to justify situational choices verbally, and articulation deepens the judgement itself.
- **Draw on your real repertoire.** Before the assessment, recall five real situations where you mediated, escalated, coached, or held an evidential line. Fresh, specific memories calibrate your judgement better than abstract principles.
- **At your level, mind the altitude.** Senior candidates fail these assessments in two symmetrical ways: doing the junior's job (taking over work, fixing artefacts yourself) or over-escalating (sending upward what you are paid to resolve). Check each option against your actual role level.

### Common pitfalls

- **Answering idealistically rather than effectively.** The perfect-world answer ("simply get everyone to agree") differs from the effective answer in a real organisation with deadlines, politics, and history. Choose what would actually work.
- **Selecting passive options.** Waiting, hoping, noting concerns for the record, and deferring to absent seniors all score poorly — they delay action, pass the problem on, or ignore the root cause. Even when escalation is right, active escalation with options beats passive referral.
- **Ignoring the organisation's values.** In UK public sector contexts, options that compromise accessibility, inclusion, or transparency are almost never "most effective", whatever their short-term pragmatism.
- **Choosing confrontation as strength.** Public challenges, ultimatums, and unilateral corrections read as decisive but score as relationship damage. The framework's own language — mediate, mend, build consensus — tells you what the scoring key values.
- **Protecting yourself instead of the outcome.** Options built around documentation of concerns, covering emails, and formal records of dissent optimise for blamelessness. Assessments — and executives — can tell.
- **Forgetting the least-effective question.** Candidates polish their "most effective" choice and guess the "least effective". Weak options cluster around passivity, public humiliation, evidence-tampering, and unilateralism; learn the clusters and the second half of each question becomes fast.

## Conclusion

Well done — you have worked through a substantial set of practice materials covering all four assessment types you are likely to meet as a business architect: cognitive ability, numerical reasoning, verbal reasoning, and situational judgement.

Along the way, you have practised far more than test technique. You have checked capability models for structural errors, recomputed the arithmetic behind benefits claims and headcount plans, read standards and stakeholder emails with forensic precision, and weighed difficult judgement calls involving executives, junior colleagues, vendors, and users with accessibility needs. Every one of those exercises maps directly to the skills your role demands: business architecture, communicating information, consultancy, making and guiding decisions, methods and tools, stakeholder relationship management, strategic design and business change, and strategic thinking.

A few encouragements as you move forward. First, remember that assessment performance is a skill in itself, and skills respond to practice: if some questions caught you out today, that is the practice doing its job. Revisit the explanations, notice the recurring patterns — denominators, qualifiers, modal verbs, the fix-the-problem-and-the-system heuristic — and try similar questions again in a week. Second, treat the preparation tips as professional development, not just test preparation: the habits these assessments reward are the habits that make you a better architect every day. Third, be confident in what you already bring. You work daily with complex information, senior stakeholders, and consequential decisions; assessments simply sample, in miniature, what you already do at scale.

If you are preparing for a real assessment, find out the format, timing, and provider in advance, complete any official practice tests offered, and look after the basics — rest, a quiet environment, and a steady pace. And whatever the outcome, keep investing in your development: seek feedback, find opportunities to mediate and to model, guide others generously, and keep sharing the value of business architecture with your organisation.
