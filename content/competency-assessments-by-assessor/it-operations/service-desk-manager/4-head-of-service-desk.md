...
abilities the IT operations profession's **head of service desk** role level
...
The head of service desk is responsible for managing a team who provides
first- and second-line technical support, ensuring the team can advise on
future projects and current issues, and managing and monitoring service desk
SLAs and performance. This assessment turns that description into a
...
interview, a work sample or task (for example, reviewing a service desk
...
head of function or senior sponsor.
...
sustained track record — a trend in user needs the person picked up on and
acted on over time, a strategy that changed how the desk performed over
years — over a single task. If you cannot point to evidence for a rating,
...
- Ask how the candidate assures asset recording accuracy across a whole
  function.
...
- Ask for an example of a structural customer service improvement the
  candidate delivered across a whole function, with its measured effect.
...
- Ask what prediction methodologies or approaches the candidate has used.
...
- Ask a referee about the candidate's track record anticipating problems at
  scale.
...
- Ask for an example of reshaping how a group of services worked together,
  and its effect.
- Ask how the candidate has advised a project team on emerging service
  design.
...
- Ask the candidate to describe how they have applied ITIL life cycle
